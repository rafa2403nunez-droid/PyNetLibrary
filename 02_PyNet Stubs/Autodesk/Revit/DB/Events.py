...
class WorksharedOperationProgressChangedEventArgs(RevitAPISingleEventArgs, IDisposable):
...
class DataTransferProgressChangedEventArgs(WorksharedOperationProgressChangedEventArgs, IDisposable):
...
class CreateRelatedFileProgressChangedEventArgs(DataTransferProgressChangedEventArgs, IDisposable):
    ...
    CreatingCloudSharedLocal = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if it is creating cloud shared local model.

Get: CreatingCloudSharedLocal(self: CreateRelatedFileProgressChangedEventArgs) -> bool

"""

    DownloadFinished = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if all data downloads are finished.

Get: DownloadFinished(self: CreateRelatedFileProgressChangedEventArgs) -> bool

"""

    FullDownload = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if download the full data of the document, which will take longer than subsequent downloads.

Get: FullDownload(self: CreateRelatedFileProgressChangedEventArgs) -> bool

"""



class DataTransferMode(Enum, IComparable, IFormattable, IConvertible):
    """
...
class DocumentReloadedLatestEventArgs(RevitAPIPostDocEventArgs, IDisposable):
    """
...
Get: Location(self: DocumentReloadedLatestEventArgs) -> str

Set: Location(self: DocumentReloadedLatestEventArgs) = value
"""



class DocumentReloadingLatestEventArgs(RevitAPIPreDocEventArgs, IDisposable):
...
class DocumentReloadLatestProgressChangedEventArgs(DataTransferProgressChangedEventArgs, IDisposable):
...
class DocumentSavedAsEventArgs(RevitAPIPostDocEventArgs, IDisposable):
    ...
    IsSavingAsCentralFile = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates whether the document is to be saved as central file.

Get: IsSavingAsCentralFile(self: DocumentSavedAsEventArgs) -> bool
...
class DocumentSaveToCentralProgressChangedEventArgs(DataTransferProgressChangedEventArgs, IDisposable):
...
class DocumentSaveToLocalProgressChangedEventArgs(WorksharedOperationProgressChangedEventArgs, IDisposable):
...
Get: IsSavingAsCentralFile(self: DocumentSavingAsEventArgs) -> bool
...
class LinkedResourceOpenedEventArgs(RevitAPIPostDocEventArgs, IDisposable):
    ...
    LinkedResourcePathName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Path of the linked resource.

Get: LinkedResourcePathName(self: LinkedResourceOpenedEventArgs) -> str
...
Get: ResourceType(self: LinkedResourceOpenedEventArgs) -> ExternalResourceType

"""



class LinkedResourceOpeningEventArgs(RevitAPIPreEventArgs, IDisposable):
...
Get: LinkedResourcePathName(self: LinkedResourceOpeningEventArgs) -> str
...
Get: ResourceType(self: LinkedResourceOpeningEventArgs) -> ExternalResourceType
...
class ViewExportedEventArgs(RevitAPIPostDocEventArgs, IDisposable):
...
Get: ViewId(self: ViewExportedEventArgs) -> ElementId

"""



class ViewExportingEventArgs(RevitAPIPreDocEventArgs, IDisposable):
...
Get: ViewId(self: ViewExportingEventArgs) -> ElementId
...
class ViewsExportedByContextEventArgs(RevitAPIPostDocEventArgs, IDisposable):
    ...
    def GetViewIds(self):
        """
        GetViewIds(self: ViewsExportedByContextEventArgs) -> IList[ElementId]
...
class ViewsExportingByContextEventArgs(RevitAPIPreDocEventArgs, IDisposable):
    ...
    def GetViewIds(self):
        """
        GetViewIds(self: ViewsExportingByContextEventArgs) -> IList[ElementId]
