...
class AirCoolingCoilType(Enum, IComparable, IFormattable, IConvertible):
    """
    The type of air cooling coil.
    
    enum AirCoolingCoilType, values: ChilledWater (1), DirectExpansion (2), None (0)
    """
    ...
    ChilledWater = None
    DirectExpansion = None
    None = None
    value__ = None


class AirFanType(Enum, IComparable, IFormattable, IConvertible):
    """
    The type of air fan.
    
    enum AirFanType, values: ConstantVolume (0), VariableVolume (1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class AirHeatExchangerType(Enum, IComparable, IFormattable, IConvertible):
    """
    The type of air loop.
    
    enum AirHeatExchangerType, values: Enthalpy (1), None (0), Sensible (2)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class AirHeatingCoilType(Enum, IComparable, IFormattable, IConvertible):
    """
    The type of air heating coil.
    
    enum AirHeatingCoilType, values: ElectricResistance (1), Furnace (2), HotWater (3), None (0)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class AirSystemData(object, IDisposable):
    """ Represents the data and parameter of analytical air system. """
    def Dispose(self):
        """ Dispose(self: AirSystemData) """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: AirSystemData, disposing: bool) """
        pass
    ...
    AirFanType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The fan type.

Get: AirFanType(self: AirSystemData) -> AirFanType

Set: AirFanType(self: AirSystemData) = value
"""

    ChilledWaterLoopId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The chilled water loop used for the chilled water option of cooling coil.

Get: ChilledWaterLoopId(self: AirSystemData) -> ElementId

Set: ChilledWaterLoopId(self: AirSystemData) = value
"""

    CoolingCoilType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The cooling coil type. Note this property change would reset the chilled water loop.

Get: CoolingCoilType(self: AirSystemData) -> AirCoolingCoilType

Set: CoolingCoilType(self: AirSystemData) = value
"""

    HeatExchangerType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The type of heat exchanger.

Get: HeatExchangerType(self: AirSystemData) -> AirHeatExchangerType

Set: HeatExchangerType(self: AirSystemData) = value
"""

    HeatingCoilType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The heating coil type. Note this property change would reset the heating water loop.

Get: HeatingCoilType(self: AirSystemData) -> AirHeatingCoilType

Set: HeatingCoilType(self: AirSystemData) = value
"""

    HeatingHotWaterLoopId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The water loop element id for the hot-water heating coil.

Get: HeatingHotWaterLoopId(self: AirSystemData) -> ElementId

Set: HeatingHotWaterLoopId(self: AirSystemData) = value
"""

    IsValidObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Specifies whether the .NET object represents a valid Revit entity.

Get: IsValidObject(self: AirSystemData) -> bool

"""

    PreheatCoilType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The preheat coil type. Note this property change would reset the preheat water loop.

Get: PreheatCoilType(self: AirSystemData) -> AirHeatingCoilType

Set: PreheatCoilType(self: AirSystemData) = value
"""

    PreheatHotWaterLoopId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The water loop element id for the hot-water preheat coil.

Get: PreheatHotWaterLoopId(self: AirSystemData) -> ElementId

Set: PreheatHotWaterLoopId(self: AirSystemData) = value
"""



class AnalyticalSystemDomain(Enum, IComparable, IFormattable, IConvertible):
    """
    The domain type of analytical system.
    
    enum AnalyticalSystemDomain, values: AirSystem (1), ElectricalSystem (2), WaterLoop (0)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
"""
    ...
    SetDownFromBottom = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The abbreviation of the Set Down from bottom (BD) of fitting string.

Get: SetDownFromBottom(self: DuctSettings) -> str

Set: SetDownFromBottom(self: DuctSettings) = value
"""
...
"""
    ...
    SetUpFromBottom = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The abbreviation of the Set Up from bottom (BU) of fitting string.

Get: SetUpFromBottom(self: DuctSettings) -> str

Set: SetUpFromBottom(self: DuctSettings) = value
"""
...
class EquipmentClassification(Enum, IComparable, IFormattable, IConvertible):
    """
    This enumeration is used to classify the mechanical equipment.
    
    enum EquipmentClassification, values: None (0), Pump (5)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class MechanicalEquipment(MEPModel, IDisposable):
    ...
    def Dispose(self):
        """ Dispose(self: MEPModel, A_0: bool) """
        pass
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: MEPModel, disposing: bool)ReleaseUnmanagedResources(self: APIObject) """
        pass
...
class MechanicalEquipmentSet(Element, IDisposable):
    """ A set of interrelated mechanical equipment in a MEP system that works together. """
    def Add(self, elemIds):
        """ Add(self: MechanicalEquipmentSet, elemIds: ISet[ElementId]) """
        pass

    @staticmethod
    def AreElementsNotConnectedInSeries(document, elemIds):
        """ AreElementsNotConnectedInSeries(document: Document, elemIds: ISet[ElementId]) -> bool """
        pass

    @staticmethod
    def AreValidMembers(document, memberIds):
        """ AreValidMembers(document: Document, memberIds: ISet[ElementId]) -> bool """
        pass

    @staticmethod
    def Create(document, typeId, memberIds):
        """ Create(document: Document, typeId: ElementId, memberIds: ISet[ElementId]) -> MechanicalEquipmentSet """
        pass
    ...
    def GetMembers(self):
        """
        GetMembers(self: MechanicalEquipmentSet) -> ISet[ElementId]
    ...
    def Remove(self, elemIds):
        """ Remove(self: MechanicalEquipmentSet, elemIds: ISet[ElementId]) """
        pass
...
Get: Classification(self: MechanicalEquipmentSet) -> EquipmentClassification

"""

    OnDuty = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The number of pieces of mechanical equipment operating in parallel at any given time.

Get: OnDuty(self: MechanicalEquipmentSet) -> int

Set: OnDuty(self: MechanicalEquipmentSet) = value
"""

    OnStandby = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The number of pieces of mechanical equipment that are not operational at any given time.

Get: OnStandby(self: MechanicalEquipmentSet) -> int

Set: OnStandby(self: MechanicalEquipmentSet) = value
"""



class MechanicalEquipmentSetType(ElementType, IDisposable):
    ...
    def Create(document, name):
        """
        Create(document: Document, name: str) -> MechanicalEquipmentSetType
...
class MEPAnalyticalSystem(Element, IDisposable):
    """ Represents an analytical system where the air or water is circulated to satisfy building energy requirements. """
    @staticmethod
    def Create(document, domain, name):
        """
        Create(document: Document, domain: AnalyticalSystemDomain, name: str) -> MEPAnalyticalSystem
            ...
            name: The name of new analytical system. The actual name may be post-fixed if already 
             exists.
    ...
    def GetAirSystemData(self):
        """
        GetAirSystemData(self: MEPAnalyticalSystem) -> AirSystemData
    ...
    def GetWaterLoopData(self):
        """
        GetWaterLoopData(self: MEPAnalyticalSystem) -> WaterLoopData
    ...
    AnalyticalSystemDomain = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The type of analytical system.

Get: AnalyticalSystemDomain(self: MEPAnalyticalSystem) -> AnalyticalSystemDomain
...
class MEPHiddenLineSettings(Element, IDisposable):
    ...
    @staticmethod
    def GetMEPHiddenLineSettings(doc):
        """
        GetMEPHiddenLineSettings(doc: Document) -> MEPHiddenLineSettings
    ...
    DrawHiddenLine = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if duct or piping is drawn with the line style and gaps specified for hidden lines.

Get: DrawHiddenLine(self: MEPHiddenLineSettings) -> bool

Set: DrawHiddenLine(self: MEPHiddenLineSettings) = value
"""

    InsideGap = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The gap for the lines that appear within a crossing segment.

Get: InsideGap(self: MEPHiddenLineSettings) -> float

Set: InsideGap(self: MEPHiddenLineSettings) = value
"""
...
Get: LineStyle(self: MEPHiddenLineSettings) -> ElementId

Set: LineStyle(self: MEPHiddenLineSettings) = value
"""

    OutsideGap = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The gap for the lines that appear external to the crossing segments.

Get: OutsideGap(self: MEPHiddenLineSettings) -> float

Set: OutsideGap(self: MEPHiddenLineSettings) = value
"""

    SingleLineGap = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The gap for the single hidden lines where segments cross.

Get: SingleLineGap(self: MEPHiddenLineSettings) -> float

Set: SingleLineGap(self: MEPHiddenLineSettings) = value
"""
...
class OccupancyUnit(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum OccupancyUnit, values: AreaPerPerson (1), BySpaceType (-1), NumberOfPeople (0), UseDefaultValues (-1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class RiseDropSymbol(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum RiseDropSymbol, values: Backslash (6), BackslashFilled (7), BendFullCircle (14), BendThreeQuarterCircle (13), Cross (2), CrossFilled (3), CrossNoOutline (17), CustomSymbol (-1), NoSymbol (0), Outline (1), OutlineFilled (10), ReverseWye (9), ReverseWyeFilled (19), Slash (4), SlashFilled (5), TeeFullCircle (16), TeeHalfCircle (15), Wye (8), WyeFilled (18), YinYang (11), YinYangFilled (12)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
Get: AirChangesPerHour(self: Space) -> float
...
"""
    ...
    OutdoorAirflow = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Get the Outdoor Airflow of the Space.

Get: OutdoorAirflow(self: Space) -> float
...
Get: OutdoorAirFlowStandard(self: Space) -> OutdoorAirFlowStandard
...
Get: OutdoorAirPerArea(self: Space) -> float
...
Get: OutdoorAirPerPerson(self: Space) -> float
...
Get: SpaceTypeId(self: Space) -> ElementId

Set: SpaceTypeId(self: Space) = value
"""
...
class SpaceType(Enum, IComparable, IFormattable, IConvertible):
    ...
    kConfinementCellsCourtHouse = None
    kConfinementCellsPenitentiary = None
...
class SystemZoneData(GenericZoneDomainData, IDisposable):
    ...
    def Dispose(self):
        """ Dispose(self: GenericZoneDomainData, A_0: bool) """
        pass
    ...
    ZoneEquipmentId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The id of the zone equipment related to the zone.

Get: ZoneEquipmentId(self: SystemZoneData) -> ElementId

Set: ZoneEquipmentId(self: SystemZoneData) = value
"""



class WaterChillerType(Enum, IComparable, IFormattable, IConvertible):
    """
    The type of water chiller.
    
    enum WaterChillerType, values: AirCooled (0), WaterCooled (1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class WaterLoopData(object, IDisposable):
    """ Represents the data and parameters of analytical water loop. """
    def Dispose(self):
        """ Dispose(self: WaterLoopData) """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: WaterLoopData, disposing: bool) """
        pass
    ...
    ChillerType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The type of water chiller. Note this property change would reset the condenser water loop.

Get: ChillerType(self: WaterLoopData) -> WaterChillerType

Set: ChillerType(self: WaterLoopData) = value
"""

    CondenserWaterLoopId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The water loop element id for the water cooled chiller.

Get: CondenserWaterLoopId(self: WaterLoopData) -> ElementId

Set: CondenserWaterLoopId(self: WaterLoopData) = value
"""

    IsValidObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Specifies whether the .NET object represents a valid Revit entity.

Get: IsValidObject(self: WaterLoopData) -> bool

"""

    WaterLoopType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The type of water loop. Note this property change would reset other properties.

Get: WaterLoopType(self: WaterLoopData) -> WaterLoopType

Set: WaterLoopType(self: WaterLoopData) = value
"""



class WaterLoopType(Enum, IComparable, IFormattable, IConvertible):
    """
    The type of water loop.
    
    enum WaterLoopType, values: ChilledWater (1), CondenserWater (2), HotWater (3), Undefined (0), VRF (4)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class ZoneEquipment(Element, IDisposable):
    """ Represents an early-stage equipment placeholder that provides heating or cooling to part of air system or water loop. """
    @staticmethod
    def Create(document, *__args):
        """
        Create(document: Document, name: str) -> ZoneEquipment
        
            Creates a new zone equipment
        
            document: The document where the new element will be created.
            name: The name of new zone equipment. The actual name may be post-fixed if already 
             exists.
        
            Returns: The newly created zone equipment.
        Create(document: Document, systemDomain: AnalyticalSystemDomain, name: str) -> ZoneEquipment
        
            Creates a new zone equipment
        
            document: The document where the new element will be created.
            systemDomain: The system domain of zone equipment.
            name: The name of new zone equipment. The actual name may be post-fixed if already 
             exists.
    ...
    @staticmethod
    def GetAssociatedZoneEquipment(document, *__args):
        """
        GetAssociatedZoneEquipment(document: Document, spaceElementId: ElementId) -> ISet[ElementId]
            ...
            Returns: All associated zone equipment, either explicitly assigned or implicitly 
             assigned via system-zone.
        
        GetAssociatedZoneEquipment(document: Document, spaces: ISet[ElementId]) -> ISet[ElementId]
        """
        pass
    ...
    def GetZoneEquipmentData(self):
        """
        GetZoneEquipmentData(self: ZoneEquipment) -> ZoneEquipmentData
    ...
    @staticmethod
    def MoveSpaceToEquipment(document, analyticalSpaceSet, originalZoneEquipmentId, targetZoneEquipmentId):
        """ MoveSpaceToEquipment(document: Document, analyticalSpaceSet: ISet[ElementId], originalZoneEquipmentId: ElementId, targetZoneEquipmentId: ElementId) """
        pass
...
class ZoneEquipmentBehavior(Enum, IComparable, IFormattable, IConvertible):
    """
    The behavior of zone equipment associated with spaces.
    
    enum ZoneEquipmentBehavior, values: GroupSpaces (1), OnePerSpace (0)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class ZoneEquipmentData(object, IDisposable):
    """ Represents the data and parameters of analytical zone equipment. """
    def Dispose(self):
        """ Dispose(self: ZoneEquipmentData) """
        pass

    def IsDataCompleted(self):
        """
        IsDataCompleted(self: ZoneEquipmentData) -> bool
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: ZoneEquipmentData, disposing: bool) """
        pass
    ...
    AirSystemId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The air system used for this zone equipment, if applicable.

Get: AirSystemId(self: ZoneEquipmentData) -> ElementId

Set: AirSystemId(self: ZoneEquipmentData) = value
"""

    ChilledWaterLoopId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The chilled water loop used for the chilled water option of cooling coil.

Get: ChilledWaterLoopId(self: ZoneEquipmentData) -> ElementId

Set: ChilledWaterLoopId(self: ZoneEquipmentData) = value
"""

    CondenserWaterLoopId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The condenser water loop used for the direction expansion water cooled option of cooling coil.

Get: CondenserWaterLoopId(self: ZoneEquipmentData) -> ElementId

Set: CondenserWaterLoopId(self: ZoneEquipmentData) = value
"""

    CoolingCoilType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The type of cooling coil. Note this property change would reset the chilled water loop.

Get: CoolingCoilType(self: ZoneEquipmentData) -> AirCoolingCoilType

Set: CoolingCoilType(self: ZoneEquipmentData) = value
"""

    EquipmentBehavior = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The behavior of how zone equipment is allocated with assigned spaces.

Get: EquipmentBehavior(self: ZoneEquipmentData) -> ZoneEquipmentBehavior

Set: EquipmentBehavior(self: ZoneEquipmentData) = value
"""

    EquipmentType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The type of zone equipment. Note this property would reset other properties.

Get: EquipmentType(self: ZoneEquipmentData) -> ZoneEquipmentHvacType

Set: EquipmentType(self: ZoneEquipmentData) = value
"""

    HeatingCoilType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The type of heating coil. Note this property change would reset the hot water loop.

Get: HeatingCoilType(self: ZoneEquipmentData) -> AirHeatingCoilType

Set: HeatingCoilType(self: ZoneEquipmentData) = value
"""

    HotWaterLoopId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The water loop element id for the hot-water heating coil.

Get: HotWaterLoopId(self: ZoneEquipmentData) -> ElementId

Set: HotWaterLoopId(self: ZoneEquipmentData) = value
"""

    IsValidObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Specifies whether the .NET object represents a valid Revit entity.

Get: IsValidObject(self: ZoneEquipmentData) -> bool

"""

    VRFLoopId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The Varible Refrigerant Flow loop for the VRF fan coil equipment type.

Get: VRFLoopId(self: ZoneEquipmentData) -> ElementId

Set: VRFLoopId(self: ZoneEquipmentData) = value
"""



class ZoneEquipmentHvacType(Enum, IComparable, IFormattable, IConvertible):
    """
    The type of zone equipment.
    
    enum ZoneEquipmentHvacType, values: CAVBox (9), ChilledBeamActive (1), ChilledBeamPassive (15), FourPipeFanCoil (2), PackagedTerminalAirConditioner (3), PackagedTerminalHeatPump (4), ParallelFanPoweredBox (5), RadiantPanel (10), SeriesFanPoweredBox (11), Unconditioned (16), Undefined (0), UnitHeater (12), UnitVentilator (13), VAVBox (6), VRFFanCoil (17), WaterSourceHeatPump (14)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
    ...
    CAVBox = None
    ChilledBeamActive = None
    ChilledBeamPassive = None
    FourPipeFanCoil = None
    PackagedTerminalAirConditioner = None
    PackagedTerminalHeatPump = None
    ParallelFanPoweredBox = None
    RadiantPanel = None
    SeriesFanPoweredBox = None
    Unconditioned = None
    Undefined = None
    UnitHeater = None
    UnitVentilator = None
