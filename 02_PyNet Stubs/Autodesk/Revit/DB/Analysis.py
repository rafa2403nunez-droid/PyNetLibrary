...
class AllowLargeGeometry(Enum, IComparable, IFormattable, IConvertible):
    """
    An enumerated type containing settings information related to handling of large geometries.
    
    enum AllowLargeGeometry, values: Allow (1), DisAllow (0), Prompt (2)
    """
...
Get: Transparency(self: AnalysisDisplayColoredSurfaceSettings) -> int

Set: Transparency(self: AnalysisDisplayColoredSurfaceSettings) = value
"""
...
class AnalysisDisplayStyleVectorArrowheadScale(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum AnalysisDisplayStyleVectorArrowheadScale, values: Length10Percent (2), Length15Percent (3), Length20Percent (4), Length5Percent (1), NoArrow (5), NoScaling (0)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class AnalysisMode(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum AnalysisMode, values: BuildingElements (0), ConceptualMasses (1), ConceptualMassesAndBuildingElements (2), RoomsOrSpaces (3)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class EnergyAnalysisDetailModel(Element, IDisposable):
    ...
    BuildingTypeId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The building type element.

Get: BuildingTypeId(self: EnergyAnalysisDetailModel) -> ElementId

Set: BuildingTypeId(self: EnergyAnalysisDetailModel) = value
"""
...
class EnergyDataSettings(Element, IDisposable):
    ...
    def GetReportsFolderParsed(self):
        """
        GetReportsFolderParsed(self: EnergyDataSettings) -> str
    ...
    def SetReportsFolder(self, folderPath):
        """
        SetReportsFolder(self: EnergyDataSettings, folderPath: str)
            Sets the reports folder path.
        
            folderPath: The string to specify the path. It may include the special label for project 
             name.
        """
        pass
...
Get: BuildingTypeId(self: EnergyDataSettings) -> ElementId

Set: BuildingTypeId(self: EnergyDataSettings) = value
"""
...
"""
    ...
    ReportsFolder = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The folder path where all systems analysis reports are stored. It may include special label and relative path.

Get: ReportsFolder(self: EnergyDataSettings) -> str
...
class EnergyModelType(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum EnergyModelType, values: AnalysisMode (2), BuildingElement (1), SpatialElement (0)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class gbXMLBuildingType(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum gbXMLBuildingType, values: AutomotiveFacility (0), ConventionCenter (1), Courthouse (2), CustomizeBuildingType (-2), DiningBarLoungeOrLeisure (3), DiningCafeteriaFastFood (4), DiningFamily (5), Dormitory (6), ExerciseCenter (7), FireStation (8), Gymnasium (9), HospitalOrHealthcare (10), Hotel (11), Library (12), Manufacturing (13), Motel (14), MotionPictureTheatre (15), MultiFamily (16), Museum (17), NoBuildingType (-1), NoOfBuildingTypes (33), Office (18), ParkingGarage (19), Penitentiary (20), PerformingArtsTheater (21), PoliceStation (22), PostOffice (23), ReligiousBuilding (24), Retail (25), SchoolOrUniversity (26), SingleFamily (27), SportsArena (28), TownHall (29), Transportation (30), Warehouse (31), Workshop (32)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class gbXMLSpaceType(Enum, IComparable, IFormattable, IConvertible):
    ...
    ConfinementCellsCourtHouse = None
    ConfinementCellsPenitentiary = None
...
class GenericZone(Element, IDisposable):
    """ Provides access to the GenericZone Element in Autodesk Revit. """
    @staticmethod
    def Create(doc, name, domainData, levelId, curveLoops):
        """ Create(doc: Document, name: str, domainData: GenericZoneDomainData, levelId: ElementId, curveLoops: IList[CurveLoop]) -> GenericZone """
        pass
    ...
    def GetBoundaries(self):
        """
        GetBoundaries(self: GenericZone) -> IList[CurveLoop]
    ...
    def GetDomainData(self):
        """
        GetDomainData(self: GenericZone) -> GenericZoneDomainData
        
            Gets the domain data for the generic zone.
            Returns: Returns a pointer to the base class for specific domain requirements for the 
             generic zone.
        """
        pass
...
Get: LevelOffset(self: GenericZone) -> float

Set: LevelOffset(self: GenericZone) = value
"""



class GenericZoneDomainData(object, IDisposable):
    """ A base class for specific domain requirements for a generic zone. """
    def Dispose(self):
        """ Dispose(self: GenericZoneDomainData) """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: GenericZoneDomainData, disposing: bool) """
        pass
...
Get: IsValidObject(self: GenericZoneDomainData) -> bool

"""



class HVACLoadType(Element, IDisposable):
    ...
    AirChangesPerHour = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The air changes per hour.

Get: AirChangesPerHour(self: HVACLoadType) -> float

Set: AirChangesPerHour(self: HVACLoadType) = value
"""

    AreaPerPerson = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The area per person.

Get: AreaPerPerson(self: HVACLoadType) -> float

Set: AreaPerPerson(self: HVACLoadType) = value
"""
...
Get: CoolingSetPoint(self: HVACLoadType) -> float

Set: CoolingSetPoint(self: HVACLoadType) = value
"""
...
Get: DehumidificationSetPoint(self: HVACLoadType) -> float

Set: DehumidificationSetPoint(self: HVACLoadType) = value
"""
...
Get: HeatingSetPoint(self: HVACLoadType) -> float

Set: HeatingSetPoint(self: HVACLoadType) = value
"""
...
Get: HumidificationSetPoint(self: HVACLoadType) -> float

Set: HumidificationSetPoint(self: HVACLoadType) = value
"""
...
Get: LatentHeatGainPerPerson(self: HVACLoadType) -> float

Set: LatentHeatGainPerPerson(self: HVACLoadType) = value
"""

    LightingLoadDensity = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The lighting load density.

Get: LightingLoadDensity(self: HVACLoadType) -> float

Set: LightingLoadDensity(self: HVACLoadType) = value
"""

    OutdoorAirFlowStandard = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The outdoor airflow standard.

Get: OutdoorAirFlowStandard(self: HVACLoadType) -> OutdoorAirFlowStandard

Set: OutdoorAirFlowStandard(self: HVACLoadType) = value
"""

    OutdoorAirPerArea = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The outdoor air per area.

Get: OutdoorAirPerArea(self: HVACLoadType) -> float

Set: OutdoorAirPerArea(self: HVACLoadType) = value
"""

    OutdoorAirPerPerson = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The outdoor air per person.

Get: OutdoorAirPerPerson(self: HVACLoadType) -> float

Set: OutdoorAirPerPerson(self: HVACLoadType) = value
"""

    PlenumLighting = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The percentage of plenum lighting contribution.

Get: PlenumLighting(self: HVACLoadType) -> float

Set: PlenumLighting(self: HVACLoadType) = value
"""

    PowerLoadDensity = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The power load density.

Get: PowerLoadDensity(self: HVACLoadType) -> float

Set: PowerLoadDensity(self: HVACLoadType) = value
"""
...
Get: SensibleHeatGainPerPerson(self: HVACLoadType) -> float

Set: SensibleHeatGainPerPerson(self: HVACLoadType) = value
"""



class HVACLoadBuildingType(HVACLoadType, IDisposable):
    """ The type element of building. """
    @staticmethod
    def Create(document, name):
        """
        Create(document: Document, name: str) -> HVACLoadBuildingType
    ...
    def IsNameUnique(self, *__args):
        """
        IsNameUnique(document: Document, name: str) -> bool
        
            Determines whether a potential building type name is unique.
        
            document: The document.
            name: The candidate name.
        IsNameUnique(self: HVACLoadBuildingType, name: str) -> bool
    ...
    @staticmethod
    def IsValidTime(hourMinute):
        """
        IsValidTime(hourMinute: str) -> bool
        
            Check if the string can be parsed to a valid time for opening time and closing 
             time. A valid string can be "16:30" or "4:30 PM";
        """
        pass
    ...
    BuildingTypeName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The building type name.

Get: BuildingTypeName(self: HVACLoadBuildingType) -> str

Set: BuildingTypeName(self: HVACLoadBuildingType) = value
"""

    ClosingTime = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The closing time of the building type.

Get: ClosingTime(self: HVACLoadBuildingType) -> str

Set: ClosingTime(self: HVACLoadBuildingType) = value
"""

    OpeningTime = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The opening time of the building type.

Get: OpeningTime(self: HVACLoadBuildingType) -> str

Set: OpeningTime(self: HVACLoadBuildingType) = value
"""

    UnoccupiedCoolingSetPoint = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The unoccupied cooling set point of the building type with unit kelvin (K).

Get: UnoccupiedCoolingSetPoint(self: HVACLoadBuildingType) -> float

Set: UnoccupiedCoolingSetPoint(self: HVACLoadBuildingType) = value
"""
...
class HVACLoadSpaceType(HVACLoadType, IDisposable):
    """ The type element of space. """
    @staticmethod
    def Create(document, name):
        """
        Create(document: Document, name: str) -> HVACLoadSpaceType
    ...
    def IsNameUnique(self, *__args):
        ...
        IsNameUnique(document: Document, name: str) -> bool
            ...
            document: The document.
            name: The candidate name.
        IsNameUnique(self: HVACLoadSpaceType, name: str) -> bool
    ...
    IsPlenum = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """True if the space type is plenum.

Get: IsPlenum(self: HVACLoadSpaceType) -> bool

"""

    SpaceTypeName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The space type name.

Get: SpaceTypeName(self: HVACLoadSpaceType) -> str

Set: SpaceTypeName(self: HVACLoadSpaceType) = value
"""
...
"""
    ...
    SpaceTypeId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The space type element of the MassZone.

Get: SpaceTypeId(self: MassZone) -> ElementId

Set: SpaceTypeId(self: MassZone) = value
"""
...
class OutdoorAirFlowStandard(Enum, IComparable, IFormattable, IConvertible):
    """
    An enumerated type listing all the possible outdoor airflow standard for a space type.
    
    enum OutdoorAirFlowStandard, values: ByACH (1), ByPeopleAndByArea (0), MaxByACH_ByArea_ByPeople (4), MaxByACH_ByPeopleByArea (3), MaxByPeople_ByArea (2)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
    ...
    ByACH = None
    ByPeopleAndByArea = None
    MaxByACH_ByArea_ByPeople = None
    MaxByACH_ByPeopleByArea = None
    MaxByPeople_ByArea = None
    value__ = None


class PathOfTravel(Element, IDisposable):
    """
    An element which holds a graphical representation of the shortest route between two points in the plane of a floor plan view.
       ...
       Route calculation is affected by properties of the Autodesk::Revit::DB::Analysis::RouteAnalysisSettingsRouteAnalysisSettings element.
    """
    @staticmethod
    def Create(DBView, pathStart, pathEnd, resultStatus=None):
        """
        Create(DBView: View, pathStart: XYZ, pathEnd: XYZ) -> (PathOfTravel, PathOfTravelCalculationStatus)
        
            Creates a new path of travel between two points and provides creation result 
             status.
        
        
            DBView: The floor plan view to use when computing the shortest distance.
            pathStart: The start point of the path. The input Z coordinates are ignored and set to the 
             view's level elevation.
        
            pathEnd: The end point of the path. The input Z coordinates are ignored and set to the 
             view's level elevation.
        
            Returns: The newly created path of travel element, or ll if no path between the two 
             points is found.
        
        Create(DBView: View, pathStart: XYZ, pathEnd: XYZ) -> PathOfTravel
    ...
    @staticmethod
    def CreateMapped(DBView, pathStarts, pathEnds, resultStatus=None):
        """
        CreateMapped(DBView: View, pathStarts: IList[XYZ], pathEnds: IList[XYZ]) -> (IList[PathOfTravel], IList[PathOfTravelCalculationStatus])
        CreateMapped(DBView: View, pathStarts: IList[XYZ], pathEnds: IList[XYZ]) -> IList[PathOfTravel]
        """
        pass

    @staticmethod
    def CreateMultiple(DBView, pathStarts, pathEnds, resultStatus=None):
        """
        CreateMultiple(DBView: View, pathStarts: IList[XYZ], pathEnds: IList[XYZ]) -> IList[PathOfTravel]
        CreateMultiple(DBView: View, pathStarts: IList[XYZ], pathEnds: IList[XYZ]) -> (IList[PathOfTravel], IList[PathOfTravelCalculationStatus])
        """
        pass
    ...
    @staticmethod
    def FindEndsOfShortestPaths(DBView, destinationPoints, startPoints):
        """ FindEndsOfShortestPaths(DBView: View, destinationPoints: IList[XYZ], startPoints: IList[XYZ]) -> IList[XYZ] """
        pass

    @staticmethod
    def FindShortestPaths(DBView, destinationPoints, startPoints):
        """ FindShortestPaths(DBView: View, destinationPoints: IList[XYZ], startPoints: IList[XYZ]) -> IList[IList[XYZ]] """
        pass

    @staticmethod
    def FindStartsOfLongestPathsFromRooms(DBView, destinationPoints):
        """ FindStartsOfLongestPathsFromRooms(DBView: View, destinationPoints: IList[XYZ]) -> IList[XYZ] """
        pass
    ...
    def GetCurves(self):
        """
        GetCurves(self: PathOfTravel) -> IList[Curve]
    ...
    def GetWaypoints(self):
        """
        GetWaypoints(self: PathOfTravel) -> IList[XYZ]
    ...
    def InsertWaypoint(self, waypoint, index):
        """
        InsertWaypoint(self: PathOfTravel, waypoint: XYZ, index: int)
    ...
    @staticmethod
    def IsInRevealObstaclesMode(DBView):
        """
        IsInRevealObstaclesMode(DBView: View) -> bool
    ...
    def RemoveWaypoint(self, index):
        """
        RemoveWaypoint(self: PathOfTravel, index: int)
            Remove a waypoint.
    ...
    @staticmethod
    def SetRevealObstaclesMode(DBView, newState):
        """
        SetRevealObstaclesMode(DBView: View, newState: bool) -> PathOfTravelCalculationStatus
    ...
    def SetWaypoint(self, waypoint, index):
        """
        SetWaypoint(self: PathOfTravel, waypoint: XYZ, index: int)
    ...
    def Update(self):
        """
        Update(self: PathOfTravel) -> PathOfTravelCalculationStatus
        
            Updates the path of travel by recalculating the path between the original start 
             and end points.
    ...
    @staticmethod
    def UpdateMultiple(adoc, elementsToUpdate, resultStatus=None):
        """
        UpdateMultiple(adoc: Document, elementsToUpdate: IList[ElementId]) -> int
        UpdateMultiple(adoc: Document, elementsToUpdate: IList[ElementId]) -> (int, IList[PathOfTravelCalculationStatus])
        """
        pass
...
Get: LineStyle(self: PathOfTravel) -> ElementId

Set: LineStyle(self: PathOfTravel) = value
"""
...
Get: PathEnd(self: PathOfTravel) -> XYZ

Set: PathEnd(self: PathOfTravel) = value
"""

    PathMidpoint = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The midpoint of the path. The Z coordinate will equal the view's level elevation.

Get: PathMidpoint(self: PathOfTravel) -> XYZ
...
Get: PathStart(self: PathOfTravel) -> XYZ

Set: PathStart(self: PathOfTravel) = value
"""



class PathOfTravelCalculationServerIds(object):
    """ Ids for external servers implementing path of travel calculations. """
    DefaultPathOfTravelCalculationGUID = None
    __all__ = []


class PathOfTravelCalculationStatus(Enum, IComparable, IFormattable, IConvertible):
    """
    An enumerated type containing possible results of the Path of Travel calculation.
    
    enum PathOfTravelCalculationStatus, values: AreaTooLarge (2), NoPathOfTravel (1), PointOutsideActiveCrop (6), ResultAffectedByCrop (4), RevealObstaclesModeFailureDataExist (8), RevealObstaclesModeFailureWireframe (9), SplitView (3), StartAndEndPointsTooClose (5), Success (0), TemporaryModeFailureDataExist (10), TemporaryModeFailureWireframe (11), TooMuchGeometry (7)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
    ...
    AreaTooLarge = None
    NoPathOfTravel = None
    PointOutsideActiveCrop = None
    ResultAffectedByCrop = None
    RevealObstaclesModeFailureDataExist = None
    RevealObstaclesModeFailureWireframe = None
    SplitView = None
    StartAndEndPointsTooClose = None
    Success = None
    TemporaryModeFailureDataExist = None
    TemporaryModeFailureWireframe = None
    TooMuchGeometry = None
    value__ = None
...
class RouteAnalysisSettings(Element, IDisposable):
    """
    RouteAnalysisSettings is an element which contains project-wide settings for route calculations.
       The Autodesk::Revit::DB::Analysis::PathOfTravelPathOfTravel element uses these settings to calculate a route between two points in a plan view.By default, the route will go around the geometry of all visible model elements which have model geometry in the Route Analysis Zone.The Route Analysis Zone, determined per view, is the space between these two horizontal planes:
       a top plane vertically offset by Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.AnalysisZoneTopOffsetAnalysisZoneTopOffset above the view's level and
       a bottom plane vertically offset by Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.AnalysisZoneBottomOffsetAnalysisZoneBottomOffset ft above the view's level.
       ...
       You can adjust the Route Analysis Zone using Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.AnalysisZoneTopOffsetAnalysisZoneTopOffset
       and Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.AnalysisZoneBottomOffsetAnalysisZoneBottomOffset.You can specify a set of model categories you would like ignored during route calculation.
       To enable ignoring the set of specified categories, set Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.EnableIgnoredCategoryIdsEnableIgnoredCategoryIds to true.
       To change the set of ignored categories, use Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.SetIgnoredCategoryIds(System.Collections.Generic.ICollectionSetIgnoredCategoryIds method
       and Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.IgnoreImportsIgnoreImports and IgnorePointCloudsIgnorePointClouds properties.
       To query the set of ignored categories, use Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.GetIgnoredCategoryIdsGetIgnoredCategoryIds.
    """
    def Dispose(self):
        """ Dispose(self: Element, A_0: bool) """
        pass
    ...
    def GetExcludedCategoryIds(self):
        """
        GetExcludedCategoryIds(self: RouteAnalysisSettings) -> ICollection[ElementId]
        
            Returns ElementIds for Category elements which are excluded (not taken into 
             account) by route calculation.
           These categories are always excluded, 
             regardless of the 
             Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.EnableIgnoredCategoryIds 
             value.
           If an excluded category has sub-categories, then the sub-categories 
    ...
    def GetIgnoredCategoryIds(self):
        """
        GetIgnoredCategoryIds(self: RouteAnalysisSettings) -> ICollection[ElementId]
        
            Returns ElementIds for Category elements which are ignored (not taken into 
             account) route calculation.
           To enable ignoring of these categories, 
             Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.EnableIgnoredCategoryIds must 
             be set to true.
           If an ignored category has sub-categories, then the 
             sub-categories will be ignored as well.
        
            Returns: The ids of Categories which are ignored by route calculation. By default, the 
             set contains the Doors Category.
        """
        pass

    @staticmethod
    def GetRouteAnalysisSettings(cda):
        """
        GetRouteAnalysisSettings(cda: Document) -> RouteAnalysisSettings
            ...
            Returns: Returns the RouteAnalysisSettings element in project documents
           or ll for 
             family documents.
        """
        pass

    def IsLargeGeometryAllowed(self):
        """
        IsLargeGeometryAllowed(self: RouteAnalysisSettings) -> bool
    ...
    def SetIgnoredCategoryIds(self, categoryIds):
        """ SetIgnoredCategoryIds(self: RouteAnalysisSettings, categoryIds: ICollection[ElementId]) """
        pass
    ...
    AnalysisZoneBottomOffset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The bottom plane offset, in ft, of the zone used in route calculation. Default value is 8".

Get: AnalysisZoneBottomOffset(self: RouteAnalysisSettings) -> float

Set: AnalysisZoneBottomOffset(self: RouteAnalysisSettings) = value
"""

    AnalysisZoneTopOffset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The top plane offset, in ft, for the zone used in route calculation. Default value is 6'8".

Get: AnalysisZoneTopOffset(self: RouteAnalysisSettings) -> float

Set: AnalysisZoneTopOffset(self: RouteAnalysisSettings) = value
"""

    EnableIgnoredCategoryIds = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """When this setting is true, elements with category ids returned by
   Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.GetIgnoredCategoryIdsGetIgnoredCategoryIds will be ignored in route calculation.
   default is true as all elements with the Door Category Id are ignored by default.

Get: EnableIgnoredCategoryIds(self: RouteAnalysisSettings) -> bool

Set: EnableIgnoredCategoryIds(self: RouteAnalysisSettings) = value
"""

    IgnoreImports = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """If true, import instances are ignored by route calculation.
   For imports to be ignored, also Autodesk.Revit.DB.Analysis.RouteAnalysisSettings.EnableIgnoredCategoryIds must be set to true.

Get: IgnoreImports(self: RouteAnalysisSettings) -> bool

Set: IgnoreImports(self: RouteAnalysisSettings) = value
"""

    MinimumLength = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The constant storing minimum allowed length of path of travel

Get: MinimumLength(self: RouteAnalysisSettings) -> float
...
class SpatialFieldManager(Element, IDisposable):
    ...
    AllowInteractiveSettings = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """If true interactive settings dialog and pick deletion are allowed.

Get: AllowInteractiveSettings(self: SpatialFieldManager) -> bool

Set: AllowInteractiveSettings(self: SpatialFieldManager) = value
"""
...
class SystemsAnalysisOptions(object, IDisposable):
    """
    ...
    """
    def Dispose(self):
        """ Dispose(self: SystemsAnalysisOptions) """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: SystemsAnalysisOptions, disposing: bool) """
        pass
...
Get: IsValidObject(self: SystemsAnalysisOptions) -> bool

"""

    OutputFolder = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The path of the output folder for systems analysis.

Get: OutputFolder(self: SystemsAnalysisOptions) -> str

Set: OutputFolder(self: SystemsAnalysisOptions) = value
"""

    WeatherFile = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The file name of the EnergyPlus weather (*.epw).

Get: WeatherFile(self: SystemsAnalysisOptions) -> str

Set: WeatherFile(self: SystemsAnalysisOptions) = value
"""

    WorkflowFile = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The file name of the EnergyPlus workflow script.

Get: WorkflowFile(self: SystemsAnalysisOptions) -> str

Set: WorkflowFile(self: SystemsAnalysisOptions) = value
"""



class SystemsAnalysisReportStyle(Enum, IComparable, IFormattable, IConvertible):
    """
    The report style of systems analysis.
    
    enum SystemsAnalysisReportStyle, values: Detailed (0), Loads (1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class ViewSystemsAnalysisReport(View, IDisposable):
    """ Represents a report instance of the systems analysis. """
    @staticmethod
    def Create(document, viewName):
        """
        Create(document: Document, viewName: str) -> ViewSystemsAnalysisReport
            ...
            Returns: The newly created view instance, or ll if the operation fails.
        """
        pass
    ...
    @staticmethod
    def GetLatestSystemsAnalysisReport(document):
        """
        GetLatestSystemsAnalysisReport(document: Document) -> ElementId
    ...
    def GetReportContent(self):
        """
        GetReportContent(self: ViewSystemsAnalysisReport) -> str
    ...
    def IsAnalysisCompleted(self):
        """
        IsAnalysisCompleted(self: ViewSystemsAnalysisReport) -> bool
    ...
    def RequestSystemsAnalysis(self, options):
        """
        RequestSystemsAnalysis(self: ViewSystemsAnalysisReport, options: SystemsAnalysisOptions)
            Requests a new systems analysis in the background.
        
            options: The additional options to run systems analysis. If empty, use the default value 
             in the view element.
           The request may download the weather file at current 
             site location if not specified in the options.
        """
        pass
    ...
    AnalysisDateAndTime = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Identifies the analysis date and time when it was requested.

Get: AnalysisDateAndTime(self: ViewSystemsAnalysisReport) -> DateTime
...
Get: ReportStyle(self: ViewSystemsAnalysisReport) -> SystemsAnalysisReportStyle

Set: ReportStyle(self: ViewSystemsAnalysisReport) = value
"""

    SystemsAnalysisOutputFolder = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The full path of the output folder for systems analysis

Get: SystemsAnalysisOutputFolder(self: ViewSystemsAnalysisReport) -> str

"""

    SystemsAnalysisWorkflowFile = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The full path name of the original system analysis workflow file.

Get: SystemsAnalysisWorkflowFile(self: ViewSystemsAnalysisReport) -> str
...
Get: WeatherFile(self: ViewSystemsAnalysisReport) -> str
