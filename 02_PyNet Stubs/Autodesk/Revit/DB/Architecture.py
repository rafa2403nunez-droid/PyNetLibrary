...
class BalusterInfo(object, IDisposable):
    """ The class represents an instance of a railing baluster or post. """
    def Dispose(self):
        """ Dispose(self: BalusterInfo) """
        pass

    @staticmethod
    def GetReferenceNameForHost():
        """
        GetReferenceNameForHost() -> str
    ...
    @staticmethod
    def GetReferenceNameForTopRail():
        """
        GetReferenceNameForTopRail() -> str
        
            Gets the name string to be used as a reference to Top Rail in the current 
             language.
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: BalusterInfo, disposing: bool) """
        pass
    ...
    BalusterFamilyId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The id of the family used for the baluster or post.

Get: BalusterFamilyId(self: BalusterInfo) -> ElementId

Set: BalusterFamilyId(self: BalusterInfo) = value
"""

    BaseOffset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The offset from the base reference.

Get: BaseOffset(self: BalusterInfo) -> float

Set: BaseOffset(self: BalusterInfo) = value
"""

    BaseReferenceName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Represents the name of the reference for the bottom of this baluster or post.

Get: BaseReferenceName(self: BalusterInfo) -> str

Set: BaseReferenceName(self: BalusterInfo) = value
"""

    DistanceFromPreviousOrSpace = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: DistanceFromPreviousOrSpace(self: BalusterInfo) -> float

Set: DistanceFromPreviousOrSpace(self: BalusterInfo) = value
"""

    IsValidObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Specifies whether the .NET object represents a valid Revit entity.

Get: IsValidObject(self: BalusterInfo) -> bool
...
Get: Name(self: BalusterInfo) -> str

Set: Name(self: BalusterInfo) = value
"""

    Offset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The side offset of the baluster/post from the railing path.

Get: Offset(self: BalusterInfo) -> float

Set: Offset(self: BalusterInfo) = value
"""

    TopOffset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The offset from the top reference.

Get: TopOffset(self: BalusterInfo) -> float

Set: TopOffset(self: BalusterInfo) = value
"""

    TopReferenceName = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Represents the name of the reference for the top of this baluster or post.

Get: TopReferenceName(self: BalusterInfo) -> str

Set: TopReferenceName(self: BalusterInfo) = value
"""



class BalusterPattern(object, IDisposable):
    """ Baluster pattern class. """
    def Dispose(self):
        """ Dispose(self: BalusterPattern) """
        pass

    def DuplicateBaluster(self, index):
        """
        DuplicateBaluster(self: BalusterPattern, index: int) -> BalusterInfo
    ...
    def GetBaluster(self, index):
        """
        GetBaluster(self: BalusterPattern, index: int) -> BalusterInfo
        
            Gets information about the given baluster from the main baluster pattern.
        
            index: The baluster index.
            Returns: The requested baluster or ll if index is out of range.
        """
        pass

    def GetBalusterCount(self):
        """
        GetBalusterCount(self: BalusterPattern) -> int
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: BalusterPattern, disposing: bool) """
        pass

    def RemoveBaluster(self, index):
        """
        RemoveBaluster(self: BalusterPattern, index: int)
    ...
    BreakPattern = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The condition which controls breaking baluster patterns distribution.

Get: BreakPattern(self: BalusterPattern) -> BreakPatternCondition

Set: BreakPattern(self: BalusterPattern) = value
"""

    DistributionJustification = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Determines how baluster pattern distribution is justified.

Get: DistributionJustification(self: BalusterPattern) -> PatternJustification

Set: DistributionJustification(self: BalusterPattern) = value
"""

    EndSpace = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The extra space added after a whole baluster pattern.

Get: EndSpace(self: BalusterPattern) -> float

Set: EndSpace(self: BalusterPattern) = value
"""

    ExcessLengthFillBalusterId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: ExcessLengthFillBalusterId(self: BalusterPattern) -> ElementId

Set: ExcessLengthFillBalusterId(self: BalusterPattern) = value
"""

    ExcessLengthFillSpacing = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The value defines the spacing between each baluster instance inserted in the excess length.

Get: ExcessLengthFillSpacing(self: BalusterPattern) -> float

Set: ExcessLengthFillSpacing(self: BalusterPattern) = value
"""

    IsValidObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Specifies whether the .NET object represents a valid Revit entity.

Get: IsValidObject(self: BalusterPattern) -> bool
...
Get: Length(self: BalusterPattern) -> float
...
Get: PatternAngle(self: BalusterPattern) -> float

Set: PatternAngle(self: BalusterPattern) = value
"""



class BalusterPlacement(object, IDisposable):
    """ A class which contains information regarding baluster and post placement for a given railing type. """
    def Dispose(self):
        """ Dispose(self: BalusterPlacement) """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: BalusterPlacement, disposing: bool) """
        pass
    ...
    BalusterPattern = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Accesses the object containing properties related to the baluster pattern.

Get: BalusterPattern(self: BalusterPlacement) -> BalusterPattern

"""

    BalusterPerTreadFamilyId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The id of baluster per tread family.

Get: BalusterPerTreadFamilyId(self: BalusterPlacement) -> ElementId

Set: BalusterPerTreadFamilyId(self: BalusterPlacement) = value
"""

    BalusterPerTreadNumber = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The number of balusters per tread.

Get: BalusterPerTreadNumber(self: BalusterPlacement) -> int

Set: BalusterPerTreadNumber(self: BalusterPlacement) = value
"""

    IsValidObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Specifies whether the .NET object represents a valid Revit entity.

Get: IsValidObject(self: BalusterPlacement) -> bool

"""

    PostPattern = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Accesses the object containing properties related to the post pattern.

Get: PostPattern(self: BalusterPlacement) -> PostPattern

"""

    UseBalusterPerTreadOnStairs = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: UseBalusterPerTreadOnStairs(self: BalusterPlacement) -> bool

Set: UseBalusterPerTreadOnStairs(self: BalusterPlacement) = value
"""



class BreakCornerCondition(Enum, IComparable, IFormattable, IConvertible):
    """
    Condition on which the corner post is inserted.
    
    enum BreakCornerCondition, values: AnglesGreaterThan (1), EachSegmentEnd (0), Never (2)
    """
    ...
    AnglesGreaterThan = None
    EachSegmentEnd = None
    Never = None
    value__ = None


class BreakPatternCondition(Enum, IComparable, IFormattable, IConvertible):
    """
    Condition on which patterns distribution will be broken.
    
    enum BreakPatternCondition, values: AnglesGreaterThan (1), EachSegmentEnd (0), Never (2)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class MultistoryStairs(Element, IDisposable):
    """ Represents a multistory stairs element in Autodesk Revit. """
    def CanConnectLevel(self, levelId):
        """
        CanConnectLevel(self: MultistoryStairs, levelId: ElementId) -> bool
        
            Checks if the given level can be connected into multistory stairs.
           You 
             cannot connect levels between standard stairs top and bottom or already 
             connected.
    ...
    def CanDisconnectLevel(self, levelId):
        """
        CanDisconnectLevel(self: MultistoryStairs, levelId: ElementId) -> bool
        
            Checks if the given level can be disconnected from multistory stairs.
           You 
             cannot disconnect the levels of standard stair (the stair associated with the 
             Reference Level for the multistory stairs) or already disconnected.
    ...
    def ConnectLevels(self, levelIds):
        """ ConnectLevels(self: MultistoryStairs, levelIds: ISet[ElementId]) """
        pass

    @staticmethod
    def Create(stairs):
        """
        Create(stairs: Stairs) -> MultistoryStairs
        
            Creates a multistory stairs from an existing component-based stairs.
        
            stairs: A component-based stairs.
            Returns: The newly created element.  Use 
             Autodesk.Revit.DB.Architecture.MultistoryStairs.ConnectLevels(System.Collections
             .Generic.ISet to extend this to multiple stories and generate stairs groups for 
             each level height.
        """
        pass

    def DisconnectLevels(self, levelIds):
        """ DisconnectLevels(self: MultistoryStairs, levelIds: ISet[ElementId]) """
        pass
    ...
    def GetAllConnectedLevels(self):
        """
        GetAllConnectedLevels(self: MultistoryStairs) -> ISet[ElementId]
    ...
    def GetAllStairsIds(self):
        """
        GetAllStairsIds(self: MultistoryStairs) -> ISet[ElementId]
        
            Gets the ids of all the stairs in this multistory stairs.
            Returns: The ids of the stairs elements that govern groups of stairs, and the stairs 
             elements that represent individual stairs.
        """
        pass
    ...
    def GetStairsOnLevel(self, levelId):
        """
        GetStairsOnLevel(self: MultistoryStairs, levelId: ElementId) -> Stairs
    ...
    def GetStairsPlacementLevels(self, stairs):
        """
        GetStairsPlacementLevels(self: MultistoryStairs, stairs: Stairs) -> ISet[ElementId]
    ...
    @staticmethod
    def IsAcceptableForMultistoryStairs(stairs):
        """
        IsAcceptableForMultistoryStairs(stairs: Stairs) -> bool
        
            Checks if the given stairs can be used to create a multistory stairs.
        
            stairs: The given stairs to check.
            Returns: Returns true if the stairs can be used to create a multistory stairs; otherwise 
             returns false.
        """
        pass

    def IsPinned(self, stairs):
        """
        IsPinned(self: MultistoryStairs, stairs: Stairs) -> bool
    ...
    def Pin(self, levelId):
        """
        Pin(self: MultistoryStairs, levelId: ElementId) -> Stairs
        
            Restores an unpinned stairs element back into the group of stairs governed by 
             level height.
        
        
            levelId: The base level id.
           If the level id belongs to the base level of an 
             individual pinned stairs, it returns the stairs id directly.
    ...
    def Unpin(self, levelId):
        """
        Unpin(self: MultistoryStairs, levelId: ElementId) -> Stairs
        
            Removes a particular story of the stairs (identified by its base level id) from 
             a stairs group.
        
        
            levelId: The base level id.
           If the level id belongs to the base level of a unpinned 
             stairs element, it returns the stairs id directly.
...
Get: ActualTreadDepth(self: MultistoryStairs) -> float

Set: ActualTreadDepth(self: MultistoryStairs) = value
"""

    StandardStairsId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: StandardStairsId(self: MultistoryStairs) -> ElementId

"""



class NonContinuousRailInfo(object, IDisposable):
    ...
    def Dispose(self):
        """ Dispose(self: NonContinuousRailInfo) """
        pass

    def IsValidNonContinuousRailHeight(self, height):
        """
        IsValidNonContinuousRailHeight(self: NonContinuousRailInfo, height: float) -> bool
        
            Checks whether the input height is valid for a non-continuous rail in its 
             associated railing type.
        
        
            height: The height to be checked.
            Returns: True if the height is smaller than the height of 
             Autodesk::Revit::DB::Architecture::RailingType, false otherwise.
        """
        pass

    def IsValidNonContinuousRailMaterial(self, materialId):
        """
        IsValidNonContinuousRailMaterial(self: NonContinuousRailInfo, materialId: ElementId) -> bool
        
            Checks whether an ElementId is a valid material Id of a non-continuous rail.
        
            materialId: The material Id to be checked.
            Returns: True if the ElementId refers to a valid material or it is invalidElementId, 
             false otherwise.
        """
        pass

    def IsValidNonContinuousRailName(self, name):
        """
        IsValidNonContinuousRailName(self: NonContinuousRailInfo, name: str) -> bool
        
            Checks whether the input name is valid for a non-continuous rail in its 
             associated railing type.
        
        
            name: The name to be checked.
            Returns: True if the name is unique for the 
             Autodesk::Revit::DB::Architecture::RailingType, false otherwise.
        """
        pass

    def IsValidNonContinuousRailProfile(self, profileId):
        """
        IsValidNonContinuousRailProfile(self: NonContinuousRailInfo, profileId: ElementId) -> bool
        
            Checks whether the input id represents a profile which can be used as the 
             profile of this non-continuous rail.
        
        
            profileId: The profile Id to be checked.
            Returns: True if the ElementId refers to a valid NonContinuousRail profile, false 
             otherwise.
        """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: NonContinuousRailInfo, disposing: bool) """
        pass
...
Get: Height(self: NonContinuousRailInfo) -> float

Set: Height(self: NonContinuousRailInfo) = value
"""

    IsValidObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Specifies whether the .NET object represents a valid Revit entity.

Get: IsValidObject(self: NonContinuousRailInfo) -> bool
...
Get: MaterialId(self: NonContinuousRailInfo) -> ElementId

Set: MaterialId(self: NonContinuousRailInfo) = value
"""

    Name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The name of the non-continuous rail.

Get: Name(self: NonContinuousRailInfo) -> str

Set: Name(self: NonContinuousRailInfo) = value
"""

    Offset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The side offset of the non-continuous rail from a Autodesk::Revit::DB::Architecture::Railing from the railing center.

Get: Offset(self: NonContinuousRailInfo) -> float

Set: Offset(self: NonContinuousRailInfo) = value
"""

    ProfileId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The profile id of the non-continuous rail, or invalidElementId if none.

Get: ProfileId(self: NonContinuousRailInfo) -> ElementId

Set: ProfileId(self: NonContinuousRailInfo) = value
"""



class NonContinuousRailStructure(object, IDisposable):
    """ A class that represents a collection of Non-Continuous Rails being a part of Railing Type. """
    def AddNonContinuousRail(self, name, height, offset):
        """
        AddNonContinuousRail(self: NonContinuousRailStructure, name: str, height: float, offset: float) -> NonContinuousRailInfo
        
            Creates and appends a new Non-Continuous Rail to the Rail Structure.
           The 
             new Non-Continuous Rail will have the given name, height and offset.
           It 
             will have default profile and material ElementIds.
        
        
            name: The name of the non-continuous rail.
            height: The height on which the non-continuous rail will be placed.
            offset: The offset of the non-continuous rail from a 
             Autodesk::Revit::DB::Architecture::Railing center.
    ...
    def Dispose(self):
        """ Dispose(self: NonContinuousRailStructure) """
        pass

    def GetNonContinuousRail(self, index):
        """
        GetNonContinuousRail(self: NonContinuousRailStructure, index: int) -> NonContinuousRailInfo
    ...
    def GetNonContinuousRailCount(self):
        """
        GetNonContinuousRailCount(self: NonContinuousRailStructure) -> int
    ...
    def IsValidNonContinuousRailProfile(self, profileId):
        """
        IsValidNonContinuousRailProfile(self: NonContinuousRailStructure, profileId: ElementId) -> bool
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: NonContinuousRailStructure, disposing: bool) """
        pass

    def RemoveNonContinuousRail(self, index):
        """
        RemoveNonContinuousRail(self: NonContinuousRailStructure, index: int)
...
Get: IsValidObject(self: NonContinuousRailStructure) -> bool

"""



class PatternJustification(Enum, IComparable, IFormattable, IConvertible):
    """
    Justification of patterns distribution.
    
    enum PatternJustification, values: Beginning (0), Center (2), End (1), SpreadPatternToFit (3)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
    ...
    Center = None
    End = None
    SpreadPatternToFit = None
    value__ = None


class PostPattern(object, IDisposable):
    """ Post pattern class. """
    def Dispose(self):
        """ Dispose(self: PostPattern) """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: PostPattern, disposing: bool) """
        pass
    ...
    CornerPost = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Accesses the object containing properties related to the corner post.

Get: CornerPost(self: PostPattern) -> BalusterInfo

"""

    CornerPostAngle = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The angle between neighboring railing segments which conditions inserting post along a railing path.

Get: CornerPostAngle(self: PostPattern) -> float

Set: CornerPostAngle(self: PostPattern) = value
"""

    CornerPostCondition = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The condition which controls the insertion of corner posts.

Get: CornerPostCondition(self: PostPattern) -> BreakCornerCondition

Set: CornerPostCondition(self: PostPattern) = value
"""

    EndPost = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Accesses the object containing properties related to the end post.

Get: EndPost(self: PostPattern) -> BalusterInfo
...
Get: IsValidObject(self: PostPattern) -> bool

"""

    StartPost = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Accesses the object containing properties related to the start post.

Get: StartPost(self: PostPattern) -> BalusterInfo
...
class Railing(Element, IDisposable):
    ...
    def Create(document, *__args):
        ...
        Create(document: Document, stairsOrRampId: ElementId, railingTypeId: ElementId, placePosition: RailingPlacementPosition) -> ICollection[ElementId]
           ...
           If the stairs are a part of 
             Autodesk.Revit.DB.Architecture.MultistoryStairs element railings will be 
             populated on all levels.
        ...
        Create(document: Document, curveLoop: CurveLoop, railingTypeId: ElementId, baseLevelId: ElementId) -> Railing
           ...
           The curveLoop 
             should be continuous with curves which are only bounded lines and arcs on the 
             same horizontal plane.
           It also has to have maximum two curves meet in one 
             end point.
        ...
        Create(document: Document, multistoryStairsId: ElementId, levelId: ElementId, railingTypeId: ElementId, placePosition: RailingPlacementPosition) -> ISet[ElementId]
            ...
            document: The document.
            multistoryStairsId: The id of the Autodesk.Revit.DB.Architecture.MultistoryStairs that contains the 
             stairs which will be the host of this railing.
           The stairs should have no 
             associated railings yet.
        
            levelId: The level of stairs on which the new railing will be created.
           The level 
             should be one of levels defining the 
             Autodesk.Revit.DB.Architecture.MultistoryStairs element.
    ...
    def GetMultistoryStairsPlacementLevels(self):
        """
        GetMultistoryStairsPlacementLevels(self: Railing) -> ISet[ElementId]
        
            Gets the ids of the base levels of the stairs upon which this railing is placed.
            Returns: The ids of levels the railing is placed on.
           The returned set consists of a 
             subset of the base level ids of the corresponding stairs in the 
    ...
    def GetSubelementOnLevel(self, levelId):
        """
        GetSubelementOnLevel(self: Railing, levelId: ElementId) -> Subelement
        
            Gets the subelement on given level.
        
            levelId: The id of the level the railing subelement is placed on.
            Returns: The subelement in given level.
           ll will be returned if railing has no 
             subelements on given level.
        """
        pass
    ...
    @staticmethod
    def IsValidPathForRailing(curveLoop):
        """
        IsValidPathForRailing(curveLoop: CurveLoop) -> bool
        
            Checks whether a railing can be created along a railing path.
        
            curveLoop: The railing path along which the new railing will be created.
            Returns: True if the new railing path can be used in a railing definition, False 
             otherwise.
        """
        pass
    ...
    def RailingCanBeHostedByElement(self, hostId):
        ...
        RailingCanBeHostedByElement(self: Railing, hostId: ElementId) -> bool
            ...
            Checks whether the specified element can be used as a host for the railing.
             ...
             The host can be:
           stairsstairs componentrampfloorslab edgewallroof
    ...
    def ResetSupportPosition(self):
        """
        ResetSupportPosition(self: Railing)
    ...
    def SetMultistoryStairsPlacementLevels(self, levelIds):
        """ SetMultistoryStairsPlacementLevels(self: Railing, levelIds: ISet[ElementId]) """
        pass
...
class RailingType(ElementType, IDisposable):
    ...
    BalusterPlacement = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Accesses the object containing properties related to the baluster placement.

Get: BalusterPlacement(self: RailingType) -> BalusterPlacement
...
"""
    ...
    RailStructure = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The NonContinuousRailStructure.

Get: RailStructure(self: RailingType) -> NonContinuousRailStructure
...
"""
    ...
    MultistoryStairsId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: MultistoryStairsId(self: Stairs) -> ElementId
...
class StairsPath(Element, IDisposable):
    ...
    @staticmethod
    def CanCreateOnMultistoryStairs(document, multistoryStairsId):
        """
        CanCreateOnMultistoryStairs(document: Document, multistoryStairsId: LinkElementId) -> bool
        
            Checks if more stairs paths can be added on the plan views of a multistory 
             stairs.
    ...
    @staticmethod
    def CreateOnMultistoryStairs(document, multistoryStairsId, typeId):
        """
        CreateOnMultistoryStairs(document: Document, multistoryStairsId: LinkElementId, typeId: ElementId) -> IList[StairsPath]
        
            Creates a new stairs path for the stairs in a multistory stairs with the 
             specified stairs path type only in the plan view.
        
        
            document: The document.
            multistoryStairsId: The id of the multistory stairs element either in the host document or in a 
             linked document.
...
class TopographyLinkType(ElementType, IDisposable):
    ...
    def Reload(self):
        """
        Reload(self: TopographyLinkType) -> LinkLoadResult
        
            Loads or reloads the link from its currently-stored location. If the link is an
             
           external resource, Revit will contact the IExternalResourceServer to get 
             the latest version
           of the link.
...
class TopographySurface(Element, IDisposable):
    ...
    @staticmethod
    def Create(document, points, facets=None):
        """
        Create(document: Document, points: IList[XYZ]) -> TopographySurface
        Create(document: Document, points: IList[XYZ], facets: IList[PolymeshFacet]) -> TopographySurface
        """
        pass
    ...
    @staticmethod
    def IsValidFaceSet(facets, points):
        """ IsValidFaceSet(facets: IList[PolymeshFacet], points: IList[XYZ]) -> bool """
        pass
    ...
    ArePointsEditable = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: ArePointsEditable(self: TopographySurface) -> bool
