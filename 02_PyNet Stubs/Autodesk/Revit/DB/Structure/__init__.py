...
class AnalyticalModelStick(AnalyticalModel, IDisposable):
    ...
    def GetLocalCoordinateSystem(self, *__args):
        ...
        GetLocalCoordinateSystem(self: AnalyticalModelStick, parameter: float) -> Transform
            ...
            Gets the local coordinate system (LCS) that reflects analytical model 
             orientation at the specified parameter value along a curve.
...
class AreaReinforcement(Element, IDisposable):
    ...
    @staticmethod
    def ConvertRebarInSystemToRebars(doc, system):
        """
        ConvertRebarInSystemToRebars(doc: Document, system: AreaReinforcement) -> IList[ElementId]
        
            Converts all RebarInSystem elements owned by the input AreaReinforcement to 
             equivalent Rebar elements.
    ...
    def GetLayerDirection(self, layer):
        """
        GetLayerDirection(self: AreaReinforcement, layer: AreaReinforcementLayerType) -> XYZ
    ...
    def GetLineFromLayerAtIndex(self, layer, linePositionIndex):
        """
        GetLineFromLayerAtIndex(self: AreaReinforcement, layer: AreaReinforcementLayerType, linePositionIndex: int) -> Line
        
            Gets the line from the desired layer at the specified index.
        
            layer: The layer on which the line stays.
            linePositionIndex: The index of the line from the desired layer. It should be an index between 0 
             and (NumberOfLines-1).
    ...
    def GetMovedLineTransform(self, layer, linePositionIndex):
        """
        GetMovedLineTransform(self: AreaReinforcement, layer: AreaReinforcementLayerType, linePositionIndex: int) -> Transform
        
            Returns a transform representing the movement of the line relative to its 
             default position along the direction of the desired layer.
            ...
            Returns: The transform representing the movement of the line relative to its default 
             position along the direction of the desired layer.
        """
        pass

    def GetNumberOfLines(self, layer):
        """
        GetNumberOfLines(self: AreaReinforcement, layer: AreaReinforcementLayerType) -> int
        
            Gets the number of lines on the specified layer. It also counts the excluded 
             ones.
    ...
    def IsLayerActive(self, layer):
        """
        IsLayerActive(self: AreaReinforcement, layer: AreaReinforcementLayerType) -> bool
    ...
    def IsLineIncluded(self, layer, linePositionIndex):
        """
        IsLineIncluded(self: AreaReinforcement, layer: AreaReinforcementLayerType, linePositionIndex: int) -> bool
        
            Checks whether the line from the desired layer at the specified position is 
             included or not.
            ...
            Returns: Returns true if the line from the desired layer at the specified position is 
    ...
    def MoveLine(self, translation, layer, linePositionIndex):
        """
        MoveLine(self: AreaReinforcement, translation: XYZ, layer: AreaReinforcementLayerType, linePositionIndex: int)
            This method applies the translation to the line from the desired layer, at the 
             specified position.
           If the line was already moved, the method will 
             concatenate the translation with the existing movement.
           The line will be 
             translated only along the direction of the specified layer.
    ...
    def ResetMovedLineTransform(self, layer, linePositionIndex):
        """
        ResetMovedLineTransform(self: AreaReinforcement, layer: AreaReinforcementLayerType, linePositionIndex: int)
            Reset the transformation representing the movement of the line relative to its 
             default position along the direction of the specified layer. The moved line 
    ...
    def SetLayerActive(self, active, layer):
        """
        SetLayerActive(self: AreaReinforcement, active: bool, layer: AreaReinforcementLayerType)
    ...
    def SetLineIncluded(self, include, layer, linePositionIndex):
        """
        SetLineIncluded(self: AreaReinforcement, include: bool, layer: AreaReinforcementLayerType, linePositionIndex: int)
            Sets if the line from desired layer at the specified position is included or 
             not.
...
class AreaReinforcementLayerType(Enum, IComparable, IFormattable, IConvertible):
    """
    Describes the layers of an Area Reinforcement
    
    enum AreaReinforcementLayerType, values: BottomOrBackMajor (2), BottomOrBackMinor (3), TopOrFrontMajor (0), TopOrFrontMinor (1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
    ...
    BottomOrBackMajor = None
    BottomOrBackMinor = None
    TopOrFrontMajor = None
    TopOrFrontMinor = None
    value__ = None
...
class ConnectionInputPoint(object, IDisposable):
    """
    An object that holds information about a connection input point
    
    ConnectionInputPoint(pt: XYZ)
    ConnectionInputPoint(pt: XYZ, uid: Guid)
    ConnectionInputPoint()
    """
    def Dispose(self):
        """ Dispose(self: ConnectionInputPoint) """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: ConnectionInputPoint, disposing: bool) """
        pass
    ...
    @staticmethod # known case of __new__
    def __new__(self, pt=None, uid=None):
        """
        __new__(cls: type, pt: XYZ)
        __new__(cls: type, pt: XYZ, uid: Guid)
        __new__(cls: type)
        """
        pass
...
Get: Id(self: ConnectionInputPoint) -> Guid

Set: Id(self: ConnectionInputPoint) = value
"""

    IsValidObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Specifies whether the .NET object represents a valid Revit entity.

Get: IsValidObject(self: ConnectionInputPoint) -> bool
...
Get: Point(self: ConnectionInputPoint) -> XYZ

Set: Point(self: ConnectionInputPoint) = value
"""



class ConnectionInputPointInfo(object, IDisposable):
    """
    An object that holds description information about a connection input point
    
    ConnectionInputPointInfo(ptSelectionText: str, inputMemberIndex: int, restrictionType: str)
    ConnectionInputPointInfo()
    """
    def Dispose(self):
        """ Dispose(self: ConnectionInputPointInfo) """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: ConnectionInputPointInfo, disposing: bool) """
        pass
    ...
    @staticmethod # known case of __new__
    def __new__(self, ptSelectionText=None, inputMemberIndex=None, restrictionType=None):
        """
        __new__(cls: type, ptSelectionText: str, inputMemberIndex: int, restrictionType: str)
        __new__(cls: type)
        """
        pass
    ...
    InputMemberIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """A index of the input member to which the restriction applies.

Get: InputMemberIndex(self: ConnectionInputPointInfo) -> int

Set: InputMemberIndex(self: ConnectionInputPointInfo) = value
"""

    IsValidObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Specifies whether the .NET object represents a valid Revit entity.

Get: IsValidObject(self: ConnectionInputPointInfo) -> bool

"""

    PointSelectionText = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """A string used to select input point by some connections.

Get: PointSelectionText(self: ConnectionInputPointInfo) -> str

Set: PointSelectionText(self: ConnectionInputPointInfo) = value
"""

    RestrictionType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """A type of input point restriction.

Get: RestrictionType(self: ConnectionInputPointInfo) -> str

Set: RestrictionType(self: ConnectionInputPointInfo) = value
"""
...
class ExtElemChangeBeamSectionRegistry(object, IDisposable):
    """ An object that stores IExtElemChangeBeamSection """
    def Dispose(self):
        """ Dispose(self: ExtElemChangeBeamSectionRegistry) """
        pass

    @staticmethod
    def RegisterInterface(provider):
        """
        RegisterInterface(provider: IExtElemChangeBeamSection)
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: ExtElemChangeBeamSectionRegistry, disposing: bool) """
        pass
...
Get: IsValidObject(self: ExtElemChangeBeamSectionRegistry) -> bool
...
class ReinforcementRoundingManager(object, IDisposable):
    ...
    def GetLengthUnitTypeId(self):
        """
        GetLengthUnitTypeId(self: ReinforcementRoundingManager) -> ForgeTypeId
        
            Gets the identifier of the length unit quantifying the reinforcement rounding 
             values.
        """
        pass
...
class FabricSheet(Element, IDisposable):
    ...
    def IsSolidInView(self, view):
        """
        IsSolidInView(self: FabricSheet, view: View3D) -> bool
        
            Checks if this fabric sheet is shown solidly in a 3D view.
        
            view: The 3D view element
            Returns: True if fabric sheet is shown solidly, false otherwise.
        """
        pass

    def IsUnobscuredInView(self, view):
        """
        IsUnobscuredInView(self: FabricSheet, view: View) -> bool
    ...
    def SetSolidInView(self, view, solid):
        """
        SetSolidInView(self: FabricSheet, view: View3D, solid: bool)
            Sets this fabric sheet to be shown solidly in a 3D view.
        
            view: The 3D view element
            solid: True if fabric sheet is shown solidly, false otherwise.
        """
        pass

    def SetUnobscuredInView(self, view, unobscured):
        """
        SetUnobscuredInView(self: FabricSheet, view: View, unobscured: bool)
...
class FabricSheetType(ElementType, IDisposable):
    ...
    def SetLayoutAsCustomPattern(self, minorStartOverhang, majorStartOverhang, minorFabricWireItems, majorFabricWireItems):
        """ SetLayoutAsCustomPattern(self: FabricSheetType, minorStartOverhang: float, majorStartOverhang: float, minorFabricWireItems: IList[FabricWireItem], majorFabricWireItems: IList[FabricWireItem]) """
        pass
...
class FabricWireItem(object, IDisposable):
    ...
    @staticmethod
    def Create(distance, wireLength, wireType, wireOffset):
        """
        Create(distance: float, wireLength: float, wireType: ElementId, wireOffset: float) -> FabricWireItem
...
"""
    ...
    OffsetAlongWire = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Offset along wire direction
   Wire distance should be 0 if we want to be along the same wire

Get: OffsetAlongWire(self: FabricWireItem) -> float

Set: OffsetAlongWire(self: FabricWireItem) = value
"""
...
class IExtElemChangeBeamSection:
    ...
    def ChangeSection(self, doc, idElem):
        """
        ChangeSection(self: IExtElemChangeBeamSection, doc: Document, idElem: ElementId) -> bool
...
class IRebarUpdateServer(IExternalServer):
    """ Represents an interface that should be overridden to allow the generation and update of free form rebar geometry. """
    def GenerateCurves(self, curvesData):
        """
        GenerateCurves(self: IRebarUpdateServer, curvesData: RebarCurvesData) -> bool
        
            This function is supposed to calculate the bars in set based on data received 
             in curvesData parameter.
        
        
            curvesData: Use the members of this class to access the inputs and define the output curves 
             that make up the free form rebar.
        
            Returns: Returns true if the curve generation was successful, false otherwise.
        """
        pass

    def GetCustomHandleName(self, handleNameData):
        """
        GetCustomHandleName(self: IRebarUpdateServer, handleNameData: RebarHandleNameData) -> bool
    ...
    def GetCustomHandles(self, handlesInfoData):
        """
        GetCustomHandles(self: IRebarUpdateServer, handlesInfoData: RebarHandlesData) -> bool
        
            This function should define all handles that the Rebar has. This function is 
             called when the Rebar is created.
        
        
            handlesInfoData: Use the methods on this class to define the handles for the free form rebar. 
             Revit will use these handles to create appropriate RebarConstraints.
        
            Returns: Returns true if the handles were defined successfully, false otherwise.
        """
        pass

    def GetHandlesPosition(self, handlePositionData):
        """
        GetHandlesPosition(self: IRebarUpdateServer, handlePositionData: RebarHandlePositionData) -> bool
        
            This function is supposed to provide the positions of handles defined in 
             GetCustomHandles(). These positions will be shown on screen when the bar 
             constraints are edited.
           If a position for a handle isn't provided, that 
             handle will not be represented on screen while edit constraints.This function 
             is called when edit constraints command is lunched or during edit constraints 
             after a constraint was changed and the curve calculation was done.
        
        
            handlePositionData: Use the members of this class to access the inputs and define the handle 
             positions for this free form rebar.
        
            Returns: Returns true if calculation of handle positions was successful, false otherwise.
        """
        pass

    def TrimExtendCurves(self, trimExtendData):
        """
        TrimExtendCurves(self: IRebarUpdateServer, trimExtendData: RebarTrimExtendData) -> bool
        
            This function is supposed to trim or extend curves that were obtained from 
             calling GenerateCurves(). Also in this function can be set new constraints for 
             start and end handles.
        
        
            trimExtendData: Use the members of this class to access the inputs and define any trim/extend 
             actions to be taken for bars in the free form rebar.
...
class PathReinforcement(Element, IDisposable):
    ...
    def ConvertRebarInSystemToRebars(doc, system):
        """
        ConvertRebarInSystemToRebars(doc: Document, system: PathReinforcement) -> IList[ElementId]
        
            Converts all RebarInSystem elements owned by the input PathReinforcement to 
             equivalent Rebar elements.
...
class Rebar(Element, IDisposable):
    ...
    def CanBeMatchedWithMultipleShapes(self):
        """
        CanBeMatchedWithMultipleShapes(self: Rebar) -> bool
        
            Checks if this Rebar can be matched with multiple Rebar Shapes.
            Returns: Returns true if this Rebar can be matched with multiple Rebar Shapes, false 
             otherwise.
        """
        pass
    ...
    def ConstraintsCanBeEdited(self):
        ...
        ConstraintsCanBeEdited(self: Rebar) -> bool
           ...
           returns true, if the Rebar element's external 
             constraints are available for editing using the
           RebarConstraintsManager 
             class.  Examples of where this method would return false are:
           Rebar in 
             Groups (which do not have constraints), or legacy, sketch-based Rebar elements
        
                created before the introduction of RebarShape families in version 2009.For 
             FreeForm rebar:
           constraints can be edited if there is a valid external 
             server Guid assigned to that Rebar
        """
        pass
    ...
    @staticmethod
    def CreateFreeForm(doc, *__args):
        """
        CreateFreeForm(doc: Document, serverGUID: Guid, barType: RebarBarType, host: Element) -> Rebar
        
            Creates a free form rebar that can have constraints.
        
            doc: A Document.
            serverGUID: The API server GUID.
           Should be the same that the function GetServerId() 
             from class derived from Autodesk.Revit.DB.Structure.IRebarUpdateServer returns.
        ...
        CreateFreeForm(doc: Document, barType: RebarBarType, host: Element, curves: IList[IList[Curve]]) -> (Rebar, RebarFreeFormValidationResult)
        CreateFreeForm(doc: Document, barType: RebarBarType, host: Element, curves: IList[CurveLoop]) -> (Rebar, RebarFreeFormValidationResult)
        """
        pass

    @staticmethod
    def CreateFromCurves(doc, style, barType, startHook, endHook, host, norm, curves, startHookOrient, endHookOrient, *__args):
        """
    ...
    def CreateFromRebarShape(doc, rebarShape, barType, host, origin, xVec, yVec):
        ...
        CreateFromRebarShape(doc: Document, rebarShape: RebarShape, barType: RebarBarType, host: Element, origin: XYZ, xVec: XYZ, yVec: XYZ) -> Rebar
           ...
           The 
             instance will have the default shape parameters from the RebarShape,
           and 
             its location is based on the bounding box of the shape in the shape definition.
             
           Hooks are removed from the shape before computing its bounding box.
           If 
             appropriate hooks can be found in the document, they will be assigned 
             arbitrarily.
    ...
    def EnableHookLengthOverride(self, enable):
        """
        EnableHookLengthOverride(self: Rebar, enable: bool)
            Enables or disables the ability to override hook lengths for this rebar 
             instance.
    ...
    def GetAllRebarShapeIds(self):
        """
        GetAllRebarShapeIds(self: Rebar) -> IList[ElementId]
        
            Gets the ids of the RebarShapes elements that defines the shapes of the rebar.
            Returns: Returns the ids of the RebarShapes elements that defines the shapes of the 
             rebar.
        """
        pass

    def GetBarIndexFromReference(self, barReference):
        """
        GetBarIndexFromReference(self: Rebar, barReference: Reference) -> int
        
            Given a reference that represents a part of a bar, this method will return the 
             bar index.
    ...
    def GetCenterlineCurves(self, adjustForSelfIntersection, suppressHooks, suppressBendRadius, multiplanarOption, barPositionIndex):
        """
    ...
    def GetFreeFormAccessor(self):
        """
        GetFreeFormAccessor(self: Rebar) -> RebarFreeFormAccessor
        
            Returns an interface providing access to free-form properties and methods for 
             this Rebar element.
        
            Returns: The interface providing access to free-form properties and methods for this 
             Rebar element.
        """
        pass
    ...
    def GetHookRotationAngle(self, iEnd):
        """
        GetHookRotationAngle(self: Rebar, iEnd: int) -> float
    ...
    def GetMovedBarTransform(self, barPositionIndex):
        """
        GetMovedBarTransform(self: Rebar, barPositionIndex: int) -> Transform
        
            Returns a transform representing the movement of the bar relative to its 
             default position along the distribution path.
        
        
            barPositionIndex: The bar index.
            Returns: The transform representing the movement of the bar relative to its default 
             position along the distribution path.
        """
        pass

    def GetOverridableHookParameters(self, startHookLengthPrameters, startHookTangentLengthParameters, endHookLengthParameters, endHookTangentLengthParameters):
        """ GetOverridableHookParameters(self: Rebar) -> (ISet[ElementId], ISet[ElementId], ISet[ElementId], ISet[ElementId]) """
        pass
    ...
    def GetShapeDrivenAccessor(self):
        """
        GetShapeDrivenAccessor(self: Rebar) -> RebarShapeDrivenAccessor
        
            Returns an interface providing access to shape-driven properties and methods 
             for this Rebar element.
        
            Returns: The interface providing access to shape-driven properties and methods for this 
             Rebar element.
        """
        pass
    ...
    def GetShapeId(self):
        """
        GetShapeId(self: Rebar) -> ElementId
        
            Returns the id of the RebarShape element that defines the shape of the rebar.
        """
        pass

    def GetTransformedCenterlineCurves(self, adjustForSelfIntersection, suppressHooks, suppressBendRadius, multiplanarOption, barPositionIndex):
        """
        GetTransformedCenterlineCurves(self: Rebar, adjustForSelfIntersection: bool, suppressHooks: bool, suppressBendRadius: bool, multiplanarOption: MultiplanarOption, barPositionIndex: int) -> IList[Curve]
    ...
    def IsHookLengthOverrideEnabled(self):
        """
        IsHookLengthOverrideEnabled(self: Rebar) -> bool
        
            Returns True if the ability to override hook lengths is enabled for this rebar 
             instance, False otherwise.
        """
        pass

    def IsRebarFreeForm(self):
        """
        IsRebarFreeForm(self: Rebar) -> bool
    ...
    def IsRebarShapeDriven(self):
        """
        IsRebarShapeDriven(self: Rebar) -> bool
    ...
    def MoveBarInSet(self, barPositionIndex, moveTransform):
        """
        MoveBarInSet(self: Rebar, barPositionIndex: int, moveTransform: Transform)
            This method applies the transformation matrix to the rebar bar at the desired 
             position in the rebar set.
           If the bar was already moved, the method will 
             concatenate the transformation matrix with the existing movement.
    ...
    @staticmethod
    def RebarShapeMatchesCurvesHooksAndEndTreatment(rebarShape, barType, norm, curves, startHook, endHook, startHookOrient, endHookOrient, hookRotationAngleAtStart, hookRotationAngleAtEnd, endTreatmentTypeIdAtStart, endTreatmentTypeIdAtEnd):
        """ RebarShapeMatchesCurvesHooksAndEndTreatment(rebarShape: RebarShape, barType: RebarBarType, norm: XYZ, curves: IList[Curve], startHook: RebarHookType, endHook: RebarHookType, startHookOrient: RebarHookOrientation, endHookOrient: RebarHookOrientation, hookRotationAngleAtStart: float, hookRotationAngleAtEnd: float, endTreatmentTypeIdAtStart: ElementId, endTreatmentTypeIdAtEnd: ElementId) -> bool """
        pass
    ...
    def ResetMovedBarTransform(self, barPositionIndex):
        """
        ResetMovedBarTransform(self: Rebar, barPositionIndex: int)
            Reset the transformation representing the movement of the bar relative to its 
             default position along the distribution path.
           The moved bar transform will 
             be set to Identity.
    ...
    def SetBarIncluded(self, include, barPositionIndex):
        """
        SetBarIncluded(self: Rebar, include: bool, barPositionIndex: int)
    ...
    def SetEndTreatmentTypeId(self, end, endTreatmentTypeId):
        """
        SetEndTreatmentTypeId(self: Rebar, end: int, endTreatmentTypeId: ElementId)
            Sets the id of the EndTreatmentType to be applied to the rebar.
           This can be 
             done if and only if the end of the bar on which the end treatment is applied 
             has no RebarCoupler on it, otherwise will throw an exception.
           If a 
             RebarHookType is present at the rebar end, it will automatically set to 
             invalidElementId.
        
        
            end: 0 for the start end treatment, 1 for the end end treatment.
            endTreatmentTypeId: The id of a EndTreatmentType element, or invalidElementId if
           the rebar 
             should have no end treatment at the specified end.
        """
        pass
    ...
    def SetHookRotationAngle(self, hookRotationAngle, iEnd):
        """
        SetHookRotationAngle(self: Rebar, hookRotationAngle: float, iEnd: int)
    ...
    def SetHookTypeId(self, end, hookTypeId):
        ...
        SetHookTypeId(self: Rebar, end: int, hookTypeId: ElementId)
           ...
           If an 
             EndTreatmentType is present at the rebar end, it will automatically set to 
             invalidElementId.
...
"""
    ...
    ReadOnlyParameters = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: ReadOnlyParameters(self: Rebar) -> bool

Set: ReadOnlyParameters(self: Rebar) = value
"""
...
class RebarBarType(ElementType, IDisposable):
    ...
    def SetBarTypeDiameters(self, diametersOptions):
        """
        SetBarTypeDiameters(self: RebarBarType, diametersOptions: BarTypeDiameterOptions)
            Sets all input diameters from diametersOptions in current RebarBarType.
        
            diametersOptions: The input diameters are validated as follows :
           barModelDiameter and 
             barNominalDiameter are both positive and no more than the smallest value of 1.0 
             and the input bend diameters.
           Each bend diameter is smaller than 99.0 and 
             bigger than barDiameter.
        """
        pass
...
"""
    ...
    BarModelDiameter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Defines bar model diameter of rebar

Get: BarModelDiameter(self: RebarBarType) -> float

Set: BarModelDiameter(self: RebarBarType) = value
"""

    BarNominalDiameter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Defines bar nominal diameter of rebar

Get: BarNominalDiameter(self: RebarBarType) -> float

Set: BarNominalDiameter(self: RebarBarType) = value
"""
...
Get: BarModelDiameter(self: RebarBendData) -> float

Set: BarModelDiameter(self: RebarBendData) = value
"""

    BarNominalDiameter = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Defines the nominal diameter of the bar.

Get: BarNominalDiameter(self: RebarBendData) -> float

Set: BarNominalDiameter(self: RebarBendData) = value
"""
...
class RebarConstrainedHandle(object, IDisposable):
    ...
    def GetCustomHandleTag(self):
        """
        GetCustomHandleTag(self: RebarConstrainedHandle) -> int
    ...
    def GetHandleName(self):
        """
        GetHandleName(self: RebarConstrainedHandle) -> str
        
            Gets the name of the handle.
            Returns: Returns the name of the handle. In case of handles of CustomHandle type it can 
             return null if the .dll that contains the server is not loaded.
        """
        pass
    ...
    def IsCustomHandle(self):
        """
        IsCustomHandle(self: RebarConstrainedHandle) -> bool
        
            Returns true if the RebarHandleType of the RebarConstrainedHandle is 
             'CustomHandle'.
        """
        pass
...
class RebarConstraint(object, IDisposable):
    ...
    def AreGeometryTargetsTheSame(self, otherConstraint):
        """
        AreGeometryTargetsTheSame(self: RebarConstraint, otherConstraint: RebarConstraint) -> bool
        
            Returns true if the gemetrical targets (ex. face references, other rebar 
             segment references) of "this" constriant are the same as the targets of the 
             "other" constraint.
           Returns false otherwise.
           Only the reference to the 
             target piece of geometry is taken into account(ex. only face references, only 
             other rebar segment references).
           Target Element (elementId) is not taken 
             into account.
           Distance to target is not taken into account.
        
        
            otherConstraint: Returns the Element object (either Host or Rebar) which provides the constraint.
        """
        pass

    def ConstrainsRebarEnds(self):
        """
        ConstrainsRebarEnds(self: RebarConstraint) -> bool
    ...
    @staticmethod
    def Create(handle, targetReferences, isConstraintToCover, offsetValue):
        """ Create(handle: RebarConstrainedHandle, targetReferences: IList[Reference], isConstraintToCover: bool, offsetValue: float) -> RebarConstraint """
        pass
    ...
    def FlipHandleOverTarget(self):
        """
        FlipHandleOverTarget(self: RebarConstraint)
            Flips the RebarConstrainedHandle to the other side of the target bar handle, 
             maintaining the distance in absolute value.
        """
        pass
    ...
    def GetCustomHandleTag(self):
        """
        GetCustomHandleTag(self: RebarConstraint) -> int
    ...
    def GetDistanceToTargetRebar(self):
        """
        GetDistanceToTargetRebar(self: RebarConstraint) -> float
        
            Gets the distance from the RebarConstrainedHandle to the target Rebar handle 
             surface.
           The RebarConstraintType of the RebarConstraint must be 
             'ToOtherRebar.'
        
            Returns: Returns the distance from the RebarConstrainedHandle to the target Rebar handle 
             surface.
        """
        pass

    def GetRebarConstraintTargetHostFaceType(self, targetIndex=None):
        """
        GetRebarConstraintTargetHostFaceType(self: RebarConstraint, targetIndex: int) -> RebarConstraintTargetHostFaceType
           ...
           must be 'FixedDistanceToHostFace' or 'ToCover.'
            ...
            Returns: Returns the RebarConstraintTargetHostFaceType of the host Element face to which 
             the RebarConstraint is attached.
        ...
        GetRebarConstraintTargetHostFaceType(self: RebarConstraint) -> RebarConstraintTargetHostFaceType
           ...
           must be 'FixedDistanceToHostFace' or 'ToCover.'
           Will 
             throw exception if it's a multi target constraint.
    ...
    def GetTargetCoverType(self, targetIndex):
        """
        GetTargetCoverType(self: RebarConstraint, targetIndex: int) -> RebarCoverType
        
            Returns the RebarCoverType for the face specified by targetIndex. Returns null 
             if no RebarHostData is present for target element.
    ...
    def GetTargetElement(self, targetIndex=None):
        """
        GetTargetElement(self: RebarConstraint, targetIndex: int) -> Element
        
            Gets the Element object (either Host or Rebar) which provides the constraint. 
             Will return the Element which contains the face at targetIndex.
        
        
            targetIndex: The index of the target. Should be between 0 and NumberOfTargets().
            Returns: Returns the Element object (either Host or Rebar) which provides the 
             constraint. Will return the Element which contains the face at targetIndex.
    ...
    def GetTargetHostFaceAndTransform(self, targetIndex, faceTransform):
        """
        GetTargetHostFaceAndTransform(self: RebarConstraint, targetIndex: int, faceTransform: Transform) -> Face
        
            Returns the face to which the RebarConstraint is attached associated to the 
             given target index.
           The RebarConstraintType of the RebarConstraint must be 
    ...
    def GetTargetHostFaceReference(self, targetIndex=None):
        """
        GetTargetHostFaceReference(self: RebarConstraint, targetIndex: int) -> Reference
        
            Returns a reference that corresponds to the face to which the RebarConstraint 
             is attached specified by the targetIndex.
           The RebarConstraintType of the 
             RebarConstraint must be 'FixedDistanceToHostFace' or 'ToCover.'
        ...
        GetTargetHostFaceReference(self: RebarConstraint) -> Reference
           ...
           The RebarConstraintType of the RebarConstraint must be 
             'FixedDistanceToHostFace' or 'ToCover.'
           Will throw exception if it's a 
    ...
    def GetTargetRebarConstraintType(self):
        ...
        GetTargetRebarConstraintType(self: RebarConstraint) -> TargetRebarConstraintType
           ...
           Rebar must be Shape Driven Rebar 
             element.
        """
        pass
    ...
    def IsBindingHandleWithTarget(self):
        """
        IsBindingHandleWithTarget(self: RebarConstraint) -> bool
        
            Gets the relationship between two RebarConstrainedHandles.
            Returns: Returns False if only the constrained RebarConstrainedHandle follows the 
             target. Returns True if the constrained RebarConstrainedHandle and the target 
             bar handle are bound and move together.
        """
        pass
    ...
    def IsReferenceValidForConstraint(self, targetReference):
        """
        IsReferenceValidForConstraint(self: RebarConstraint, targetReference: Reference) -> bool
    ...
    def IsUsingClearBarSpacing(self):
        """
        IsUsingClearBarSpacing(self: RebarConstraint) -> bool
        
            Returns true if the RebarConstrainedHandle to target offset is the clear bar 
             distance, false if the offset is measured between bar centers.
        
            Returns: Returns true if the RebarConstrainedHandle to target offset is the clear bar 
             distance, false if the offset is measured between bar centers.
        """
        pass
    ...
    def ReplaceReferenceTargets(self, handle, targetReferences, isConstraintToCover, offsetValue):
        """ ReplaceReferenceTargets(self: RebarConstraint, handle: RebarConstrainedHandle, targetReferences: IList[Reference], isConstraintToCover: bool, offsetValue: float) """
        pass
    ...
    def SetDistanceToTargetRebar(self, distanceToTargetRebar):
        """
        SetDistanceToTargetRebar(self: RebarConstraint, distanceToTargetRebar: float)
            Sets the offset distance between the constrained RebarConstrainedHandle and its 
             target Rebar handle surface.
        
        
            distanceToTargetRebar: The distance is given as an offset value, the sign of which depends on the 
             target bar handle direction.
        """
        pass

    def SetToBindHandleWithTarget(self, bindsHandleWithTarget):
        """
        SetToBindHandleWithTarget(self: RebarConstraint, bindsHandleWithTarget: bool)
            Sets the relationship between two RebarConstrainedHandles.
        
            bindsHandleWithTarget: False if only the constrained RebarConstrainedHandle follows the target. True 
             if the constrained RebarConstrainedHandle and the target bar handle will be 
             bound and move together.
        """
        pass

    def SetToUseClearBarSpacing(self, useClearBarSpacing):
        """
        SetToUseClearBarSpacing(self: RebarConstraint, useClearBarSpacing: bool)
            Sets whether the RebarConstrainedHandle to target offset is the clear bar 
             distance, or is measured between bar centers.
        
        
            useClearBarSpacing: True if the RebarConstrainedHandle to target offset is the clear bar distance, 
             false if the offset is measured between bar centers.
        """
        pass
...
"""
    ...
    NumberOfTargets = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Identifies the number of references associated to the rebar handle.

Get: NumberOfTargets(self: RebarConstraint) -> int
...
class RebarConstraintsManager(object, IDisposable):
    ...
    """
    def AllowConstraintTargets(self, handle, targetsToConstrain):
        """ AllowConstraintTargets(self: RebarConstraintsManager, handle: RebarConstrainedHandle, targetsToConstrain: IList[Reference]) -> bool """
        pass

    def ApplyRebarConstraints(self, constraintsToApply, oldTargets, newTargets):
        """ ApplyRebarConstraints(self: RebarConstraintsManager, constraintsToApply: IList[RebarConstraint], oldTargets: IList[Reference], newTargets: IList[Reference]) -> bool """
        pass
    ...
    def GetAllHandles(self):
        """
        GetAllHandles(self: RebarConstraintsManager) -> IList[RebarConstrainedHandle]
        
            Gets all RebarConstrainedHandles of this bar.
            Returns: All RebarConstrainedHandle objects will be returned, regardless of whether 
             there are constraints associated to them.
        """
        pass

    def GetConstraintCandidatesForHandle(self, handle, *__args):
        """
        GetConstraintCandidatesForHandle(self: RebarConstraintsManager, handle: RebarConstrainedHandle) -> IList[RebarConstraint]
        
            For shape driven rebar returns all possible RebarConstraints that could be used 
             for a specified RebarConstrainedHandle.For free form rebar will return an empty 
             list.
        
        
            handle: The RebarConstrainedHandle for which constraint candidates are sought.
            Returns: A collection of RebarConstraints
        GetConstraintCandidatesForHandle(self: RebarConstraintsManager, handle: RebarConstrainedHandle, elementId: ElementId) -> IList[RebarConstraint]
        
            For shape driven rebar returns all possible RebarConstraints belonging to 
             references from the provided element that could be used for a specified 
             RebarConstrainedHandle.For free form rebar will return an empty list.
        
        
            handle: The RebarConstrainedHandle for which constraint candidates are sought.
            elementId: The elementId ( host or rebar ) of the element in which the candidates are 
             searched for.
        
            Returns: A collection of RebarConstraints
        GetConstraintCandidatesForHandle(self: RebarConstraintsManager, handle: RebarConstrainedHandle, reference: Reference) -> IList[RebarConstraint]
        
            For shape driven rebar returns all possible RebarConstraints that will 
             constrain RebarConstrainedHandle to the provided reference.For free form rebar 
             will return an empty lists.
        
        
            handle: The RebarConstrainedHandle for which constraint candidates are sought.
            reference: The reference you want to constrain to.
            Returns: A collection of RebarConstraints
        """
        pass
    ...
    def GetPreferredConstraintOnHandle(self, handle):
        ...
        GetPreferredConstraintOnHandle(self: RebarConstraintsManager, handle: RebarConstrainedHandle) -> RebarConstraint
            ...
            For ShapeDriven: Returns the RebarConstraint that has been set as preferred for 
             the specified RebarConstrainedHandle.For FreeForm:  Returns the RebarConstraint 
             that acts on the specified RebarConstraintHandle.
    ...
    def RemovePreferredConstraintFromHandle(self, handle):
        ...
        RemovePreferredConstraintFromHandle(self: RebarConstraintsManager, handle: RebarConstrainedHandle)
            For ShapeDriven: Clears the user-preferred RebarConstraint from the specified 
             RebarConstrainedHandle.For FreeForm: Removes the RebarConstraint that is 
             associated to the specified RebarConstrainedHandle.
    ...
    def SetPreferredConstraintForHandle(self, handle, constraint):
        ...
        SetPreferredConstraintForHandle(self: RebarConstraintsManager, handle: RebarConstrainedHandle, constraint: RebarConstraint)
            For ShapeDriven Rebar: Sets the RebarConstraint as preferred constraint target 
             for the specified RebarConstrainedHandle.For FreeForm Rebar: Sets the 
...
class RebarContainer(Element, IDisposable, IEnumerable[RebarContainerItem], IEnumerable):
    ...
    def AppendItemFromRebar(self, rebar):
        ...
        AppendItemFromRebar(self: RebarContainer, rebar: Rebar) -> RebarContainerItem
           ...
           Will throw 
             exception if given rebar has moved bars in set.
...
class RebarContainerItem(object, IDisposable):
    ...
    def SetFromRebar(self, rebar):
        ...
        SetFromRebar(self: RebarContainerItem, rebar: Rebar)
            Set an instance of a RebarContainerItem element according to a Rebar 
             parameters.
           Will throw exception if given rebar is not shape driven.
...
class RebarContainerParameterManager(object, IDisposable):
    ...
    def GetDoubleOverrideValue(self, paramId):
        """
        GetDoubleOverrideValue(self: RebarContainerParameterManager, paramId: ElementId) -> float
    ...
    def GetElementIdOverrideValue(self, paramId):
        """
        GetElementIdOverrideValue(self: RebarContainerParameterManager, paramId: ElementId) -> ElementId
    ...
    def GetIntOverrideValue(self, paramId):
        """
        GetIntOverrideValue(self: RebarContainerParameterManager, paramId: ElementId) -> int
    ...
    def GetStringOverrideValue(self, paramId):
        """
        GetStringOverrideValue(self: RebarContainerParameterManager, paramId: ElementId) -> str
...
class RebarCoupler(Element, IDisposable):
    ...
    def Create(doc, typeId, pFirstData, pSecondData, error):
        ...
        Create(doc: Document, typeId: ElementId, pFirstData: ReinforcementData, pSecondData: ReinforcementData) -> (RebarCoupler, RebarCouplerError)
            ...
            pSecondData: information about the second reinforcement to be coupled;
           if a nullptr is 
             passed in the coupler is placed on one reinforcement
    ...
    def GetCoupledReinforcementData(self):
        ...
        GetCoupledReinforcementData(self: RebarCoupler) -> IList[ReinforcementData]
            ...
            gets the reinforcement data. The returned list will have size = 2. If coupler 
             stays on only one bar one element in this list will be null.
        """
        pass
    ...
    def GetCouplerPositionTransform(self, couplerPositionIndex):
        ...
        GetCouplerPositionTransform(self: RebarCoupler, couplerPositionIndex: int) -> Transform
            ...
            Returns: Returns a transformation that is composed from :
           - a translation from (0, 
             0, 0) to coupler origin
           - a rotation that will align the coupler with the 
             bar segment on which it stays.
        """
        pass
    ...
    def IsUnobscuredInView(self, view):
        """
        IsUnobscuredInView(self: RebarCoupler, view: View) -> bool
    ...
    def SetUnobscuredInView(self, view, unobscured):
        """
        SetUnobscuredInView(self: RebarCoupler, view: View, unobscured: bool)
...
class RebarCouplerError(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum RebarCouplerError, values: ArcsHaveDifferentCenters (16), ArcsHaveDifferentRadii (15), ArcToStraightSegment (17), BarSegementsAreNotParallel (6), BarSegmentsAreNotOnSameLine (7), BarSegmentSmallerThanEngagement (13), BarsNotTouching (3), CurvesOtherThanLine (12), DifferentLayout (2), InconsistentShape (8), IncorrectEndTreatmentCoupler (5), IncorrectEndTreatmentHook (4), IncorrectInputData (1), InvalidDiameter (9), ValidationSuccessfuly (0), VaryingDistanceBetweenDistributionsBars (14)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
    ...
    ArcsHaveDifferentCenters = None
    ArcsHaveDifferentRadii = None
    ArcToStraightSegment = None
...
class RebarCurvesData(object, IDisposable):
    """ The class that contains the information needed to calculate and return the result of the external curve generation. """
    def AddBarGeometry(self, curves):
        """
        AddBarGeometry(self: RebarCurvesData, curves: IList[Curve]) -> RebarFreeFormValidationResult
        AddBarGeometry(self: RebarCurvesData, curves: CurveLoop) -> RebarFreeFormValidationResult
        
            Adds a new bar to the new rebar geometry. This information is set to the rebar 
             after the API execution is finished successfully.
    ...
    def CanAddBarGeometry(self):
        """
        CanAddBarGeometry(self: RebarCurvesData) -> bool
        
            If the layout rule is Singe or FixedNumber or NumberWithSpacing this function 
             will return true if getNumberOfBarGeometry() is less getBarsNumber(), false 
             otherwise.If the layout rule is MaximumSpacing or MinimumClearSpacing this 
             function will return always true.
        
            Returns: Returns true if we can add more bar geometry for the current layout, false 
             otherwise.
        """
        pass

    def ClearAllAddedBarGeometry(self):
        """
        ClearAllAddedBarGeometry(self: RebarCurvesData)
            This function will remove all bars geometry that were added by calling 
             AddBarGeometry().
        """
        pass

    def Dispose(self):
        """ Dispose(self: RebarCurvesData) """
        pass

    def GetAddedBarGeometry(self, barIndex):
        """
        GetAddedBarGeometry(self: RebarCurvesData, barIndex: int) -> IList[Curve]
        
            Gets the added curves that will represent the bar at index barIndex.
        
            barIndex: The index of the bar. Should be a number between 0 and GetNumberOfBarGeometry() 
             - 1.
        
            Returns: Returns the curves that will represent the bar at index barIndex. The hooks 
             plane normals will be applied on these curves.
        """
        pass

    def GetDistributionPath(self):
        """
        GetDistributionPath(self: RebarCurvesData) -> IList[Curve]
    ...
    def GetNumberOfBarGeometry(self):
        """
        GetNumberOfBarGeometry(self: RebarCurvesData) -> int
    ...
    def GetRebarUpdateCurvesData(self):
        """
        GetRebarUpdateCurvesData(self: RebarCurvesData) -> RebarUpdateCurvesData
        
            Gets a class that contains information used as input and output for rebar free 
             form calculation.
        
            Returns: Gets a class that contains information used as input and output for rebar free 
             form calculation.
        """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: RebarCurvesData, disposing: bool) """
        pass

    def SetDistributionPath(self, path):
        """ SetDistributionPath(self: RebarCurvesData, path: IList[Curve]) """
        pass
...
Get: IsValidObject(self: RebarCurvesData) -> bool
...
class RebarFreeFormAccessor(object, IDisposable):
    """ A class that is used to access the properties and capabilities of free-form Rebar. """
    def AddUpdatingSharedParameter(self, parameterId):
        """
        AddUpdatingSharedParameter(self: RebarFreeFormAccessor, parameterId: ElementId)
            Add existing shared parameter as a dependency for the calculation of the rebar 
             curves.
    ...
    def CanBeHookNormal(self, barIndex, end, normal):
        """
        CanBeHookNormal(self: RebarFreeFormAccessor, barIndex: int, end: int, normal: XYZ) -> bool
        
            A vector can be hook normal if for a bar specified by index, the bar direction 
             is not parallel with the vector.
    ...
    def DisconnectFromServer(self):
        """
        DisconnectFromServer(self: RebarFreeFormAccessor)
            Sets the GUID of the API server to invalid value and removes all the server 
             related data from the Rebar (ex. the current constraints and the handle tags 
             are removed).
           Calling this method will result in a Rebar that will not 
             react to host changes anymore, however it will still have all the properties 
             that it used to have.
        """
        pass

    def Dispose(self):
        """ Dispose(self: RebarFreeFormAccessor) """
        pass

    def GetCouplerIdAtIndex(self, barPositionIndex, end):
        """
        GetCouplerIdAtIndex(self: RebarFreeFormAccessor, barPositionIndex: int, end: int) -> ElementId
        
            Gets the id of the Rebar Coupler that is applied to the bar with index 
             barPositionIndex at the specified end.
    ...
    def GetCustomDistributionPath(self):
        """
        GetCustomDistributionPath(self: RebarFreeFormAccessor) -> IList[Curve]
    ...
    def GetEndTreatmentTypeIdAtIndex(self, barPositionIndex, end):
        """
        GetEndTreatmentTypeIdAtIndex(self: RebarFreeFormAccessor, barPositionIndex: int, end: int) -> ElementId
        
            Gets the id of the EndTreatmentType that is applied to the bar with index 
             barPositionIndex at the specified end.
    ...
    def GetHookOrientationAngle(self, end):
        """
        GetHookOrientationAngle(self: RebarFreeFormAccessor, end: int) -> float
    ...
    def GetHookOrientationAngleAtIndex(self, barPositionIndex, end):
        """
        GetHookOrientationAngleAtIndex(self: RebarFreeFormAccessor, barPositionIndex: int, end: int) -> float
        
            Gets the hook orientation angle that is applied to this Rebar at the bar with 
             index barPositionIndex at the specified end.
    ...
    def GetHookOrientationAtIndex(self, barPositionIndex, end):
        """
        GetHookOrientationAtIndex(self: RebarFreeFormAccessor, barPositionIndex: int, end: int) -> RebarHookOrientation
        
            Gets the hook orientation that is applied to this Rebar at the bar with index 
             barPositionIndex at the specified end.
    ...
    def GetHookPlaneNormalForBarIdx(self, end, barPositionIndex):
        """
        GetHookPlaneNormalForBarIdx(self: RebarFreeFormAccessor, end: int, barPositionIndex: int) -> XYZ
        
            Returns the normal of plane in which the hook at end of bar with index 
             barPositionIndex will stay.
        
        
            end: The end of bar. Should be 0 for start or 1 for end.
            barPositionIndex: An index between 0 and (NumberOfBarPositions-1).
            Returns: The normal of plane in which the hook at end of bar with index barPositionIndex 
             will stay.
        """
        pass

    def GetHookTypeIdAtIndex(self, barPositionIndex, end):
        """
        GetHookTypeIdAtIndex(self: RebarFreeFormAccessor, barPositionIndex: int, end: int) -> ElementId
        
            Gets the id of the RebarHookType that is applied to this Rebar at the bar with 
             index barPositionIndex at the specified end.
        
        
            barPositionIndex: An index between 0 and (NumberOfBarPositions-1).
            end: 0 for the start hook, 1 for the end hook.
            Returns: The id of a RebarHookType, or invalidElementId if the rebar has no hook at the 
             specified end.
        """
        pass
    ...
    def GetServerGUID(self):
        """
        GetServerGUID(self: RebarFreeFormAccessor) -> Guid
    ...
    def GetShapeIdAtIndex(self, barPositionIndex):
        """
        GetShapeIdAtIndex(self: RebarFreeFormAccessor, barPositionIndex: int) -> ElementId
    ...
    def GetUpdatingSharedParameters(self):
        """
        GetUpdatingSharedParameters(self: RebarFreeFormAccessor) -> IList[ElementId]
        
            Get the shared parameters listed as dependencies in the calculation of the 
             rebar curves
    ...
    def HasValidServer(self):
        """
        HasValidServer(self: RebarFreeFormAccessor) -> bool
    ...
    def IsBarMatchedWithShapeInReverseOrder(self, barPositionIndex):
        """
        IsBarMatchedWithShapeInReverseOrder(self: RebarFreeFormAccessor, barPositionIndex: int) -> bool
        
            Checks if the bar at index barPositionIndex it's matched in reversed order with 
             its shape.
        
        
            barPositionIndex: An index between 0 and (NumberOfBarPositions-1).
            Returns: Returns true if the bar is matched in reversed order with its shape, false 
             otherwise.
        """
        pass
    ...
    def IsUnconstrained(self):
        """
        IsUnconstrained(self: RebarFreeFormAccessor) -> bool
        
            Returns true if the current rebar doesn't contains a valid server GUID, or 
             contains a valid server GUID and no valid constraints.
        
            Returns: Returns true if the current rebar doesn't contains a valid server GUID, or 
             contains a valid server GUID and no valid constraints.
           Returns false if the 
             current rebar contains a valid server GUID and has valid constraints.
        """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: RebarFreeFormAccessor, disposing: bool) """
        pass

    def RemoveUpdatingSharedParameter(self, parameterId):
        """
        RemoveUpdatingSharedParameter(self: RebarFreeFormAccessor, parameterId: ElementId)
            Remove existing shared parameter as a dependency for the calculation of the 
             rebar curves.
    ...
    def SetCurves(self, curves):
        """
        SetCurves(self: RebarFreeFormAccessor, curves: IList[IList[Curve]]) -> RebarFreeFormValidationResult
        SetCurves(self: RebarFreeFormAccessor, curves: IList[CurveLoop]) -> RebarFreeFormValidationResult
        """
        pass

    def SetHookOrientationAngle(self, end, angle):
        """
        SetHookOrientationAngle(self: RebarFreeFormAccessor, end: int, angle: float)
            Set the hook orientation angle at end. Will throw exception if the rebar has 
             valid constraints.
    ...
    def SetHookPlaneNormalForBarIdx(self, end, barPositionIndex, hookNormal):
        """
        SetHookPlaneNormalForBarIdx(self: RebarFreeFormAccessor, end: int, barPositionIndex: int, hookNormal: XYZ)
            Set the normal of plane in which the hook at end of bar with index 
             barPositionIndex will stay. Will throw exception if the rebar has valid 
             constraints.
        
        
            end: The end of bar. Should be 0 for start or 1 for end.
            barPositionIndex: An index between 0 and (NumberOfBarPositions-1).
            hookNormal: The normal of plane in which the hook at end of bar with index barPositionIndex 
             will stay.
        """
        pass

    def SetLayoutAsFixedNumber(self, numberOfBars):
        """
        SetLayoutAsFixedNumber(self: RebarFreeFormAccessor, numberOfBars: int)
    ...
    def SetLayoutAsMaximumSpacing(self, spacing):
        """
        SetLayoutAsMaximumSpacing(self: RebarFreeFormAccessor, spacing: float)
    ...
    def SetLayoutAsMinimumClearSpacing(self, spacing):
        """
        SetLayoutAsMinimumClearSpacing(self: RebarFreeFormAccessor, spacing: float)
    ...
    def SetLayoutAsNumberWithSpacing(self, numberOfBars, spacing):
        """
        SetLayoutAsNumberWithSpacing(self: RebarFreeFormAccessor, numberOfBars: int, spacing: float)
    ...
    def SetLayoutAsSingle(self):
        """
        SetLayoutAsSingle(self: RebarFreeFormAccessor)
            Sets the Layout Rule property of rebar set to Single.
        """
        pass

    def SetReportedShape(self, rebarShapeId):
        """
        SetReportedShape(self: RebarFreeFormAccessor, rebarShapeId: ElementId)
            This method changes the RebarShape of a Free Form Rebar that is using 
             RebarWorkInstructions.Straight property to the provided RebarShape.
        """
        pass
...
Get: IsValidObject(self: RebarFreeFormAccessor) -> bool
...
Get: RebarStyle(self: RebarFreeFormAccessor) -> RebarStyle

Set: RebarStyle(self: RebarFreeFormAccessor) = value
"""

    StirrupTieAttachmentType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: StirrupTieAttachmentType(self: RebarFreeFormAccessor) -> StirrupTieAttachmentType

Set: StirrupTieAttachmentType(self: RebarFreeFormAccessor) = value
"""

    WorkshopInstructions = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Identifies the workshop instructions of the current Rebar element.

Get: WorkshopInstructions(self: RebarFreeFormAccessor) -> RebarWorkInstructions

Set: WorkshopInstructions(self: RebarFreeFormAccessor) = value
"""



class RebarFreeFormValidationResult(Enum, IComparable, IFormattable, IConvertible):
    """
    Errors for the Free Form Rebar
    
    enum RebarFreeFormValidationResult, values: InvalidLoop (4), NullCurve (2), RebarCantBeBent (5), Success (0), UnboundCurve (3), Undefined (1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class RebarGeometryType(Enum, IComparable, IFormattable, IConvertible):
    """
    Rebar geometry type
    
    enum RebarGeometryType, values: FreeForm (1), ShapeBased (0)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class RebarHandleNameData(object, IDisposable):
    """ This class is used to contain the information about the rebar handle name defined by an external application. """
    def Dispose(self):
        """ Dispose(self: RebarHandleNameData) """
        pass

    def GetCustomHandleTag(self):
        """
        GetCustomHandleTag(self: RebarHandleNameData) -> int
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: RebarHandleNameData, disposing: bool) """
        pass

    def SetCustomHandleName(self, customHandleName):
        """
        SetCustomHandleName(self: RebarHandleNameData, customHandleName: str)
...
Get: IsValidObject(self: RebarHandleNameData) -> bool

"""



class RebarHandlePositionData(object, IDisposable):
    """ The class that contains data for the handle position calculation. """
    def Dispose(self):
        """ Dispose(self: RebarHandlePositionData) """
        pass

    def GetBarGeometry(self, barIndex):
        """
        GetBarGeometry(self: RebarHandlePositionData, barIndex: int) -> IList[Curve]
    ...
    def GetDistributionPath(self):
        """
        GetDistributionPath(self: RebarHandlePositionData) -> IList[Curve]
    ...
    def GetNumberOfBars(self):
        """
        GetNumberOfBars(self: RebarHandlePositionData) -> int
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: RebarHandlePositionData, disposing: bool) """
        pass

    def SetPosition(self, handleTag, position):
        """
        SetPosition(self: RebarHandlePositionData, handleTag: int, position: XYZ)
            Sets the position for a specified handle. This information is set to the rebar 
             after the API execution is finished successfully.
...
Get: IsValidObject(self: RebarHandlePositionData) -> bool

"""



class RebarHandlesData(object, IDisposable):
    """ This class is used to contain the information about the rebar handles defined by an external application. """
    def AddCustomHandle(self, customHandleTag):
        """
        AddCustomHandle(self: RebarHandlesData, customHandleTag: int)
            Adds a new handle definition to the rebar. This information is set to the rebar 
             after the API execution is finished successfully.
        
        
            customHandleTag: The tag of the handle. The tag should be different from the previous ones that 
             were added.
        """
        pass

    def Dispose(self):
        """ Dispose(self: RebarHandlesData) """
        pass

    def GetCustomHandles(self):
        """
        GetCustomHandles(self: RebarHandlesData) -> IList[int]
    ...
    def GetEndHandle(self):
        """
        GetEndHandle(self: RebarHandlesData) -> int
    ...
    def GetStartHandle(self):
        """
        GetStartHandle(self: RebarHandlesData) -> int
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: RebarHandlesData, disposing: bool) """
        pass

    def SetEndHandle(self, endHandleTag):
        """
        SetEndHandle(self: RebarHandlesData, endHandleTag: int)
            Sets the end handle tag. This information is set to the rebar after the API 
    ...
    def SetStartHandle(self, startHandleTag):
        """
        SetStartHandle(self: RebarHandlesData, startHandleTag: int)
            Sets the start handle tag. This information is set to the rebar after the API 
             execution is finished successfully.
...
Get: IsValidObject(self: RebarHandlesData) -> bool
...
class RebarHandleType(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum RebarHandleType, values: CustomHandle (5), Edge (3), EndOfBar (2), OutOfPlaneExtent (4), RebarPlane (0), StartOfBar (1), Undefined (-1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class RebarInSystem(Element, IDisposable):
    ...
    def CanEditIndividualBars(self):
        """
        CanEditIndividualBars(self: RebarInSystem) -> bool
    ...
    def GetBarIndexFromReference(self, barReference):
        """
        GetBarIndexFromReference(self: RebarInSystem, barReference: Reference) -> int
    ...
    def GetMovedBarTransform(self, barPositionIndex):
        """
        GetMovedBarTransform(self: RebarInSystem, barPositionIndex: int) -> Transform
    ...
    def GetTransformedCenterlineCurves(self, adjustForSelfIntersection, suppressHooks, suppressBendRadius, barPositionIndex):
        """
        GetTransformedCenterlineCurves(self: RebarInSystem, adjustForSelfIntersection: bool, suppressHooks: bool, suppressBendRadius: bool, barPositionIndex: int) -> IList[Curve]
    ...
    def MoveBarInSet(self, barPositionIndex, moveTransform):
        """
        MoveBarInSet(self: RebarInSystem, barPositionIndex: int, moveTransform: Transform)
            This method applies the transformation matrix to the rebar bar at the desired 
             position in the rebar set.
           If the bar was already moved, the method will 
             concatenate the transformation matrix with the existing movement.
    ...
    def ResetMovedBarTransform(self, barPositionIndex):
        """
        ResetMovedBarTransform(self: RebarInSystem, barPositionIndex: int)
            Reset the transformation representing the movement of the bar relative to its 
             default position along the distribution path.
           The moved bar transform will 
             be set to Identity.
    ...
    def SetBarIncluded(self, include, barPositionIndex):
        """
        SetBarIncluded(self: RebarInSystem, include: bool, barPositionIndex: int)
            Sets if the bar at the desired index is included or not.
...
class RebarShape(ElementType, IDisposable):
    ...
    @staticmethod
    def Create(doc, definition, multiplanarDefinition, style, attachmentType, startHookAngle, startHookOrientation, endHookAngle, endHookOrientation, higherEnd, hookRotationAngleAtStart=None, hookRotationAngleAtEnd=None, endTreatmentTypeIdAtStart=None, endTreatmentTypeIdAtEnd=None):
        """
        ...
        Create(doc: Document, definition: RebarShapeDefinition, multiplanarDefinition: RebarShapeMultiplanarDefinition, style: RebarStyle, attachmentType: StirrupTieAttachmentType, startHookAngle: int, startHookOrientation: RebarHookOrientation, endHookAngle: int, endHookOrientation: RebarHookOrientation, higherEnd: int, hookRotationAngleAtStart: float, hookRotationAngleAtEnd: float, endTreatmentTypeIdAtStart: ElementId, endTreatmentTypeIdAtEnd: ElementId) -> RebarShape
           ...
           driven by 
            ...
            multiplanarDefinition: If not ll, the created RebarShape will be a 3D shape. The shape
           is built 
             out of the planar RebarShapeDefinition, with additional
           out-of-plane 
             segments defined by the RebarShapeMultiplanarDefinition
    ...
    def GetEndTreatmentTypeId(self, iEnd):
        ...
        GetEndTreatmentTypeId(self: RebarShape, iEnd: int) -> ElementId
            ...
            Returns: Returns the id of an EndTreatmentType, or invalidElementId if the rebar shape 
             has no end treatment at the specified end.
        """
        pass

    def GetHookRotationAngle(self, iEnd):
        """
        GetHookRotationAngle(self: RebarShape, iEnd: int) -> float
    ...
    def HasEndTreatment(self):
        ...
        HasEndTreatment(self: RebarShape) -> bool
            ...
            Returns: Returns true if the rebar shape has end treatment for at least one end, false 
             otherwise.
        """
        pass
    ...
    def SetEndTreatmentTypeId(self, endTreatmentId, iEnd):
        """
        SetEndTreatmentTypeId(self: RebarShape, endTreatmentId: ElementId, iEnd: int)
            Sets the EndTreatmentType id at the specified rebar shape end.
        
            endTreatmentId: The id of an EndTreatmentType element, or invalidElementId if the rebar shape 
             should have no end treatment at the specified end.
    ...
    def SetHookRotationAngle(self, hookRotationAngle, iEnd):
        """
        SetHookRotationAngle(self: RebarShape, hookRotationAngle: float, iEnd: int)
            Sets the out of plane hook rotation angle at the specified end.
...
class RebarShapeDrivenAccessor(object, IDisposable):
    """ A class that is used to access the properties and capabilities of shape-driven Rebar. """
    def ComputeDrivingCurves(self):
        """
        ComputeDrivingCurves(self: RebarShapeDrivenAccessor) -> IList[Curve]
    ...
    def Dispose(self):
        """ Dispose(self: RebarShapeDrivenAccessor) """
        pass

    def GetBarPositionTransform(self, barPositionIndex):
        """
        GetBarPositionTransform(self: RebarShapeDrivenAccessor, barPositionIndex: int) -> Transform
    ...
    def GetDistributionPath(self):
        """
        GetDistributionPath(self: RebarShapeDrivenAccessor) -> Line
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: RebarShapeDrivenAccessor, disposing: bool) """
        pass

    def ScaleToBox(self, origin, xVec, yVec):
        """
        ScaleToBox(self: RebarShapeDrivenAccessor, origin: XYZ, xVec: XYZ, yVec: XYZ)
    ...
    def ScaleToBoxFor3D(self, origin, xVec, yVec, height):
        """
        ScaleToBoxFor3D(self: RebarShapeDrivenAccessor, origin: XYZ, xVec: XYZ, yVec: XYZ, height: float)
    ...
    def SetLayoutAsFixedNumber(self, numberOfBarPositions, arrayLength, barsOnNormalSide, includeFirstBar, includeLastBar):
        """
        SetLayoutAsFixedNumber(self: RebarShapeDrivenAccessor, numberOfBarPositions: int, arrayLength: float, barsOnNormalSide: bool, includeFirstBar: bool, includeLastBar: bool)
            Sets the Layout Rule property of rebar set to FixedNumber.
    ...
    def SetLayoutAsMaximumSpacing(self, spacing, arrayLength, barsOnNormalSide, includeFirstBar, includeLastBar):
        """
        SetLayoutAsMaximumSpacing(self: RebarShapeDrivenAccessor, spacing: float, arrayLength: float, barsOnNormalSide: bool, includeFirstBar: bool, includeLastBar: bool)
            Sets the Layout Rule property of rebar set to MaximumSpacing
    ...
    def SetLayoutAsMinimumClearSpacing(self, spacing, arrayLength, barsOnNormalSide, includeFirstBar, includeLastBar):
        """
        SetLayoutAsMinimumClearSpacing(self: RebarShapeDrivenAccessor, spacing: float, arrayLength: float, barsOnNormalSide: bool, includeFirstBar: bool, includeLastBar: bool)
            Sets the Layout Rule property of rebar set to MinimumClearSpacing
    ...
    def SetLayoutAsNumberWithSpacing(self, numberOfBarPositions, spacing, barsOnNormalSide, includeFirstBar, includeLastBar):
        """
        SetLayoutAsNumberWithSpacing(self: RebarShapeDrivenAccessor, numberOfBarPositions: int, spacing: float, barsOnNormalSide: bool, includeFirstBar: bool, includeLastBar: bool)
            Sets the Layout Rule property of rebar set to NumberWithSpacing
    ...
    def SetLayoutAsSingle(self):
        """
        SetLayoutAsSingle(self: RebarShapeDrivenAccessor)
            Sets the Layout Rule property of rebar set to Single.
        """
        pass

    def SetRebarShapeId(self, shapeId):
        """
        SetRebarShapeId(self: RebarShapeDrivenAccessor, shapeId: ElementId)
            Changes the RebarShape element that defines the shape of the rebar.
           
             Changing the value of this member causes the Rebar instance to choose values 
             for its
           shape parameters to preserve its previous shape as closely as 
             possible
        """
        pass
...
Get: ArrayLength(self: RebarShapeDrivenAccessor) -> float

Set: ArrayLength(self: RebarShapeDrivenAccessor) = value
"""

    BarsOnNormalSide = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Identifies if the bars of the rebar set are on the same side of the rebar plane indicated by the normal.

Get: BarsOnNormalSide(self: RebarShapeDrivenAccessor) -> bool

Set: BarsOnNormalSide(self: RebarShapeDrivenAccessor) = value
"""

    BaseFinishingTurns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """For a spiral, the number of finishing turns at the lower end of the spiral.

Get: BaseFinishingTurns(self: RebarShapeDrivenAccessor) -> int

Set: BaseFinishingTurns(self: RebarShapeDrivenAccessor) = value
"""

    Height = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """For a spiral, the overall height.

Get: Height(self: RebarShapeDrivenAccessor) -> float

Set: Height(self: RebarShapeDrivenAccessor) = value
"""

    IsValidObject = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Specifies whether the .NET object represents a valid Revit entity.

Get: IsValidObject(self: RebarShapeDrivenAccessor) -> bool
...
Get: MultiplanarDepth(self: RebarShapeDrivenAccessor) -> float

Set: MultiplanarDepth(self: RebarShapeDrivenAccessor) = value
"""

    Normal = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """A unit-length vector normal to the plane of the rebar

Get: Normal(self: RebarShapeDrivenAccessor) -> XYZ
...
Get: Pitch(self: RebarShapeDrivenAccessor) -> float

Set: Pitch(self: RebarShapeDrivenAccessor) = value
"""

    TopFinishingTurns = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """For a spiral, the number of finishing turns at the upper end of the spiral.

Get: TopFinishingTurns(self: RebarShapeDrivenAccessor) -> int

Set: TopFinishingTurns(self: RebarShapeDrivenAccessor) = value
"""
...
class RebarTrimExtendData(object, IDisposable):
    ...
    def AddBarGeometry(self, curves):
        """
        AddBarGeometry(self: RebarTrimExtendData, curves: IList[Curve]) -> RebarFreeFormValidationResult
        AddBarGeometry(self: RebarTrimExtendData, curves: CurveLoop) -> RebarFreeFormValidationResult
        
            Adds a new rebar geometry. This information is set to the rebar after the API 
             execution is finished successfully.
    ...
    def CanAddBarGeometry(self):
        """
        CanAddBarGeometry(self: RebarTrimExtendData) -> bool
        
            Returns true if getNumberOfBarGeometry() is less than GetNumberOfBars(), false 
             otherwise.
        """
        pass
    ...
    def ClearAllAddedBarGeometry(self):
        """
        ClearAllAddedBarGeometry(self: RebarTrimExtendData)
            This function will remove all bars geometry that were added by calling 
             AddBarGeometry().
        """
        pass

    def CreateEndConstraint(self, targetReferences, isConstraintToCover, offsetValue):
        """ CreateEndConstraint(self: RebarTrimExtendData, targetReferences: IList[Reference], isConstraintToCover: bool, offsetValue: float) -> bool """
        pass

    def CreateStartConstraint(self, targetReferences, isConstraintToCover, offsetValue):
        """ CreateStartConstraint(self: RebarTrimExtendData, targetReferences: IList[Reference], isConstraintToCover: bool, offsetValue: float) -> bool """
        pass

    def Dispose(self):
        """ Dispose(self: RebarTrimExtendData) """
        pass

    def GetAddedBarGeometry(self, barIndex):
        """
        GetAddedBarGeometry(self: RebarTrimExtendData, barIndex: int) -> IList[Curve]
    ...
    def GetNumberOfBarGeometry(self):
        """
        GetNumberOfBarGeometry(self: RebarTrimExtendData) -> int
    ...
    def GetRebarUpdateCurvesData(self):
        """
        GetRebarUpdateCurvesData(self: RebarTrimExtendData) -> RebarUpdateCurvesData
    ...
    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: RebarTrimExtendData, disposing: bool) """
        pass
...
Get: IsValidObject(self: RebarTrimExtendData) -> bool

"""



class RebarUpdateCurvesData(object, IDisposable):
    """ Class holding the information needed to calculate the rebar curves. """
    def Dispose(self):
        """ Dispose(self: RebarUpdateCurvesData) """
        pass

    def GetAttachmentType(self):
        """
        GetAttachmentType(self: RebarUpdateCurvesData) -> StirrupTieAttachmentType
        
            Returns attachment type for stirrups to be used in cover calculation.
            Returns: InteriorFace : rebar to attach to interior face of cover reference.ExteriorFace 
             : rebar to attach to exterior face of cover reference.
        """
        pass

    def GetBarDiameter(self):
        """
        GetBarDiameter(self: RebarUpdateCurvesData) -> float
    ...
    def GetBarGeometry(self, barIndex):
        """
        GetBarGeometry(self: RebarUpdateCurvesData, barIndex: int) -> IList[Curve]
    ...
    def GetBarModelDiameter(self):
        """
        GetBarModelDiameter(self: RebarUpdateCurvesData) -> float
    ...
    def GetBarNominalDiameter(self):
        """
        GetBarNominalDiameter(self: RebarUpdateCurvesData) -> float
    ...
    def GetBarsNumber(self):
        """
        GetBarsNumber(self: RebarUpdateCurvesData) -> int
        
            Gets the number of bars specified in the layout options.
           This is used to 
             calculate the sets driven by bar number.
        
            Returns: Returns the number of bars specified in the layout options.
        """
        pass

    def GetBendingRadius(self):
        """
        GetBendingRadius(self: RebarUpdateCurvesData) -> float
    ...
    def GetChangedCustomHandles(self):
        """
        GetChangedCustomHandles(self: RebarUpdateCurvesData) -> IList[int]
        
            Returns an array containing custom handles that were changed since the last 
             regeneration.
           Array is empty if no handles were changed since the last 
             regeneration.
        
            Returns: Returns an array containing the tags of custom handles that were changed since 
             the last regeneration.
        """
        pass

    def GetChangedSharedParameterGUIDs(self):
        """
        GetChangedSharedParameterGUIDs(self: RebarUpdateCurvesData) -> IList[Guid]
        
            Returns an array containing the shared parameter GUIDs that were changed since 
             the last regeneration.
           Array is empty if no shared params were changed 
             since the last regeneration.
        
            Returns: Returns an array containing the elementId of the shared params that were 
             changed since the last regeneration.
        """
        pass

    def GetCustomConstraints(self):
        """
        GetCustomConstraints(self: RebarUpdateCurvesData) -> IList[RebarConstraint]
        
            Gets all rebar constraints that are attached to custom handles for this rebar.
            Returns: Returns all rebar constraints that are attached to custom handles for this 
             rebar. This array does not contains the start and end constraints.
        """
        pass

    def GetDocument(self):
        """
        GetDocument(self: RebarUpdateCurvesData) -> Document
    ...
    def GetEndConstraint(self):
        """
        GetEndConstraint(self: RebarUpdateCurvesData) -> RebarConstraint
        
            Gets the current constraint for the end handle of the Rebar.
            Returns: Returns the current constraint for the end handle of the Rebar. Return value is 
             null is no constraint is present.
        """
        pass

    def GetHookOrientationAngle(self, end):
        """
        GetHookOrientationAngle(self: RebarUpdateCurvesData, end: int) -> float
    ...
    def GetHookPlaneNormalForBarIdx(self, end, barPositionIndex):
        """
        GetHookPlaneNormalForBarIdx(self: RebarUpdateCurvesData, end: int, barPositionIndex: int) -> XYZ
        
            Returns the normal of plane in which the hook at end of bar with index 
             barPositionIndex that is currently in Rebar.
        
        
            end: The end of bar. Should be 0 for start or 1 for end.
            barPositionIndex: An index between 0 and (GetNumberOfBars()-1).
            Returns: The normal of plane in which the hook at end of bar with index barPositionIndex 
             that is currently in Rebar.
        """
        pass

    def GetHostId(self):
        """
        GetHostId(self: RebarUpdateCurvesData) -> ElementId
    ...
    def GetLayoutRule(self):
        """
        GetLayoutRule(self: RebarUpdateCurvesData) -> RebarLayoutRule
    ...
    def GetNumberOfBars(self):
        """
        GetNumberOfBars(self: RebarUpdateCurvesData) -> int
    ...
    def GetRebarId(self):
        """
        GetRebarId(self: RebarUpdateCurvesData) -> ElementId
    ...
    def GetRebarStyle(self):
        """
        GetRebarStyle(self: RebarUpdateCurvesData) -> RebarStyle
    ...
    def GetStartConstraint(self):
        """
        GetStartConstraint(self: RebarUpdateCurvesData) -> RebarConstraint
        
            Gets the current constraint for the start handle of the Rebar.
            Returns: Returns the current constraint for the start handle of the Rebar. Return value 
             is null if no constraint is present.
        """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: RebarUpdateCurvesData, disposing: bool) """
        pass

    def SetHookOrientationAngle(self, end, angle):
        """
        SetHookOrientationAngle(self: RebarUpdateCurvesData, end: int, angle: float)
            Set the hook orientation angle at end. This information is set to the rebar 
             after the API execution is finished successfully.
    ...
    def SetHookPlaneNormalForBarIdx(self, end, barPositionIndex, hookNormal):
        """
        SetHookPlaneNormalForBarIdx(self: RebarUpdateCurvesData, end: int, barPositionIndex: int, hookNormal: XYZ)
            Set the normal of plane in which the hook at end of bar with index 
             barPositionIndex will stay. This information is set to the rebar after the API 
             execution is finished successfully.
    ...
    AreWorkshopInstructionsChanged = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if the workshop instructions have changed since the last regeneration.

Get: AreWorkshopInstructionsChanged(self: RebarUpdateCurvesData) -> bool
...
Get: ErrorMessage(self: RebarUpdateCurvesData) -> str

Set: ErrorMessage(self: RebarUpdateCurvesData) = value
"""

    HostMirrored = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """If true, then host of the rebar was mirrorred (along with the rebar) before this regeneration.

Get: HostMirrored(self: RebarUpdateCurvesData) -> bool

Set: HostMirrored(self: RebarUpdateCurvesData) = value
"""

    IsAttachmentTypeChanged = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if the attachment type has changed since the last regeneration.

Get: IsAttachmentTypeChanged(self: RebarUpdateCurvesData) -> bool

"""

    IsBarsNumberChanged = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if the bar number has changed since the last regeneration.

Get: IsBarsNumberChanged(self: RebarUpdateCurvesData) -> bool

"""

    IsBendingRadiusChanged = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if the style has changed since the last regeneration.

Get: IsBendingRadiusChanged(self: RebarUpdateCurvesData) -> bool

"""

    IsEndConstraintChanged = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if the end handle constraint has changed since the last regeneration.

Get: IsEndConstraintChanged(self: RebarUpdateCurvesData) -> bool

"""

    IsLayoutChanged = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if the layout has changed since the last regeneration.

Get: IsLayoutChanged(self: RebarUpdateCurvesData) -> bool
...
Get: IsReversed(self: RebarUpdateCurvesData) -> bool

Set: IsReversed(self: RebarUpdateCurvesData) = value
"""

    IsSpacingChanged = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if the spacing has changed since the last regeneration.

Get: IsSpacingChanged(self: RebarUpdateCurvesData) -> bool

"""

    IsStartConstraintChanged = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if the start handle constraint has changed since the last regeneration.

Get: IsStartConstraintChanged(self: RebarUpdateCurvesData) -> bool

"""

    IsStyleChanged = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates if the style has changed since the last regeneration.

Get: IsStyleChanged(self: RebarUpdateCurvesData) -> bool
...
Get: IsValidObject(self: RebarUpdateCurvesData) -> bool
...
Get: Spacing(self: RebarUpdateCurvesData) -> float
...
Get: WorkshopInstructions(self: RebarUpdateCurvesData) -> RebarWorkInstructions

"""



class RebarWorkInstructions(Enum, IComparable, IFormattable, IConvertible):
    """
    Describes how a Free Form Rebar will be fabricated.
    
    enum RebarWorkInstructions, values: Bent (0), Straight (1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class ReinforcementSettings(Element, IDisposable):
    ...
    @staticmethod
    def GetReinforcementSettings(document):
        """
        GetReinforcementSettings(document: Document) -> ReinforcementSettings
...
class StructuralConnectionHandler(Element, IDisposable):
    ...
    def AddReferences(self, document, picks):
        """ AddReferences(self: StructuralConnectionHandler, document: Document, picks: IList[Reference]) """
        pass
    ...
    def Create(document, *__args):
        ...
        Create(document: Document, elementIds: IList[ElementId], typeName: str) -> StructuralConnectionHandler
        Create(document: Document, idsToConnect: IList[ElementId], typeId: ElementId, additionalInputPoints: IList[ConnectionInputPoint]) -> StructuralConnectionHandler
        """
        pass

    @staticmethod
    def CreateGenericConnection(document, idsToConnect):
        """ CreateGenericConnection(document: Document, idsToConnect: IList[ElementId]) -> StructuralConnectionHandler """
        pass
    ...
    def GetInputPoint(self, id):
        """
        GetInputPoint(self: StructuralConnectionHandler, id: Guid) -> ConnectionInputPoint
    ...
    def GetInputPoints(self):
        """
        GetInputPoints(self: StructuralConnectionHandler) -> IList[ConnectionInputPoint]
    ...
    def GetInputReferences(self):
        """
        GetInputReferences(self: StructuralConnectionHandler) -> IList[Reference]
    ...
    def IsCustom(self):
        """
        IsCustom(self: StructuralConnectionHandler) -> bool
    ...
    def RemoveReferences(self, picks):
        """ RemoveReferences(self: StructuralConnectionHandler, picks: IList[Reference]) """
        pass

    def SetDefaultElementOrder(self):
        """
        SetDefaultElementOrder(self: StructuralConnectionHandler)
            Sorts the connected elements connection according to structural categories, 
             element materials and geometries.
           The steel element is set rather than an 
             element of other material.
...
"""
    ...
    OverrideTypeParams = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Allow or disallow connection's type parameters to be overridden.

Get: OverrideTypeParams(self: StructuralConnectionHandler) -> bool

Set: OverrideTypeParams(self: StructuralConnectionHandler) = value
"""
...
class StructuralConnectionHandlerType(ElementType, IDisposable):
    ...
    @staticmethod
    def AddElementsToCustomConnection(structuralConnectionHandler, references):
        """ AddElementsToCustomConnection(structuralConnectionHandler: StructuralConnectionHandler, references: IList[Reference]) """
        pass

    @staticmethod
    def Create(pADoc, name, guid, familyName, categoryId=None, inputPointsInfo=None):
        """
        ...
        Create(pADoc: Document, name: str, guid: Guid, familyName: str, categoryId: ElementId) -> StructuralConnectionHandlerType
            ...
            Returns: The newly created instance.
        Create(pADoc: Document, name: str, guid: Guid, familyName: str, categoryId: ElementId, inputPointsInfo: IList[ConnectionInputPointInfo]) -> StructuralConnectionHandlerType
        """
        pass
    ...
    @staticmethod
    def FindGenericConnectionType(doc):
        """
        FindGenericConnectionType(doc: Document) -> ElementId
        
            Finds StructuralConnectionHandlerType which is Generic Connection type.
            Returns: Returns id of StructuralConnectionHandlerType which is Generic Connection type 
             of invalidElementId if not found.
        """
        pass
    ...
    def IsCustom(self):
        """
        IsCustom(self: StructuralConnectionHandlerType) -> bool
    ...
    def IsDetailed(self):
        """
        IsDetailed(self: StructuralConnectionHandlerType) -> bool
    ...
    def IsGeneric(self):
        """
        IsGeneric(self: StructuralConnectionHandlerType) -> bool
    ...
    @staticmethod
    def IsTypeNameValidForCustomConnection(document, typeName):
        """
        IsTypeNameValidForCustomConnection(document: Document, typeName: str) -> bool
        
            Validates if the input name matches the criteria of 
             StructuralConnectionHandlerType name.
           Name must be unique among other 
             existing StructuralConnectionHandlerTypes and cannot contain any of the 
             following characters: new line, {}[];`~\\/:*?";<>| or any of the non-printable 
             characters.
        
        
            document: The Document.
            typeName: The StructuralConnectionHandlerType name to validate.
            Returns: True if the input name matches the criteria of StructuralConnectionHandlerType 
             name.
        """
        pass
    ...
    @staticmethod
    def RemoveMainSubelementsFromCustomConnection(structuralConnectionHandler, subelements):
        """ RemoveMainSubelementsFromCustomConnection(structuralConnectionHandler: StructuralConnectionHandler, subelements: IList[Subelement]) """
        pass
