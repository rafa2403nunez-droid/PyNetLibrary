...
class Entity(object, IDisposable):
    ...
    def Get(self, *__args):
        ...
        Get[FieldType](self: Entity, fieldName: str, unitTypeId: ForgeTypeId) -> FieldType
        Get[FieldType](self: Entity, field: Field, unitTypeId: ForgeTypeId) -> FieldType
        """
        pass
    ...
    def Set(self, *__args):
        """ Set[FieldType](self: Entity, fieldName: str, value: FieldType)Set[FieldType](self: Entity, field: Field, value: FieldType)Set[FieldType](self: Entity, fieldName: str, value: FieldType, unitTypeId: ForgeTypeId)Set[FieldType](self: Entity, field: Field, value: FieldType, unitTypeId: ForgeTypeId) """
        pass
...
class Field(object, IDisposable):
    ...
    """
    def CompatibleUnit(self, unitTypeId):
        """
        CompatibleUnit(self: Field, unitTypeId: ForgeTypeId) -> bool
    ...
    def GetSpecTypeId(self):
        """
        GetSpecTypeId(self: Field) -> ForgeTypeId
...
class FieldBuilder(object, IDisposable):
    ...
    def SetSpec(self, specTypeId):
        """
        SetSpec(self: FieldBuilder, specTypeId: ForgeTypeId) -> FieldBuilder
