...
class PipeSettings(Element, IDisposable):
    ...
    @staticmethod
    def IsAnalysisForClosedLoopHydronicPipingNetworksEnabled(ccda):
        """
        IsAnalysisForClosedLoopHydronicPipingNetworksEnabled(ccda: Document) -> bool
        
            Indicates whether analysis for closed loop hydronic piping networks is enabled 
             in the specified document.
        
        
            ccda: The document.
            Returns: Returns true if analysis for closed loop hydronic piping networks is enabled, 
             false otherwise.
        """
        pass
    ...
    AnalysisForClosedLoopHydronicPipingNetworks = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Indicates whether to enable analysis for closed loop hydronic piping networks.

Get: AnalysisForClosedLoopHydronicPipingNetworks(self: PipeSettings) -> bool

Set: AnalysisForClosedLoopHydronicPipingNetworks(self: PipeSettings) = value
"""
...
Get: SetDownFromBottom(self: PipeSettings) -> str

Set: SetDownFromBottom(self: PipeSettings) = value
"""
...
Get: SetUpFromBottom(self: PipeSettings) -> str

Set: SetUpFromBottom(self: PipeSettings) = value
"""
...
class PipingSystem(MEPSystem, IDisposable):
    ...
    @staticmethod
    def CanBeHydraulicLoopBoundary(element):
        """
        CanBeHydraulicLoopBoundary(element: Element) -> bool
    ...
    @staticmethod
    def CreateHydraulicSeparation(document, pipeElementIds):
        """ CreateHydraulicSeparation(document: Document, pipeElementIds: ISet[ElementId]) -> ISet[ElementId] """
        pass

    @staticmethod
    def DeleteHydraulicSeparation(document, pipeElementIds):
        """ DeleteHydraulicSeparation(document: Document, pipeElementIds: ISet[ElementId]) """
        pass
    ...
    def GetPumpSets(self):
        """
        GetPumpSets(self: PipingSystem) -> ISet[ElementId]
    ...
    @staticmethod
    def IsHydraulicLoopBoundary(element):
        """
        IsHydraulicLoopBoundary(element: Element) -> bool
