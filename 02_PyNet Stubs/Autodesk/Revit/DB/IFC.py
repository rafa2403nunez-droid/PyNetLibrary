...
class IFCImportOptions(object, IDisposable):
    ...
    def GetExtraOptions(self):
        """
        GetExtraOptions(self: IFCImportOptions) -> IDictionary[str, str]
        
            Get the list of extra options to be passed into the importer.  Each entry in 
             the map is a pair of option name and value.
    ...
    def SetExtraOptions(self, options):
        """ SetExtraOptions(self: IFCImportOptions, options: IDictionary[str, str]) """
        pass
