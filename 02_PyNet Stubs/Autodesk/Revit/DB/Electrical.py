...
class CircuitConnectionType(Enum, IComparable, IFormattable, IConvertible):
    """
    An enumerated type indicates the panel to panel connection type
    
    enum CircuitConnectionType, values: Breaker (1), FeedThruLugs (2), NotApplicable (0)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class CircuitNaming(Enum, IComparable, IFormattable, IConvertible):
    """
    An enumerated type listing all the circuit naming options.
    
    enum CircuitNaming, values: Customized (5), PanelName (2), Phase (3), Prefixed (0), ProjectSetting (4), Standard (1), Undefined (-1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class CircuitNamingScheme(Element, IDisposable):
    """ This class represents a circuit naming scheme in Autodesk Revit. """
    @staticmethod
    def Create(document, name, data):
        """ Create(document: Document, name: str, data: IList[TableCellCombinedParameterData]) -> CircuitNamingScheme """
        pass
    ...
    def GetCombinedParameters(self):
        """
        GetCombinedParameters(self: CircuitNamingScheme) -> IList[TableCellCombinedParameterData]
    ...
    @staticmethod
    def IsValidCombinedParameters(aDocument, data):
        """ IsValidCombinedParameters(aDocument: Document, data: IList[TableCellCombinedParameterData]) -> bool """
        pass
    ...
    def SetCombinedParameters(self, data):
        """ SetCombinedParameters(self: CircuitNamingScheme, data: IList[TableCellCombinedParameterData]) """
        pass
...
class CircuitNamingSchemeSettings(Element, IDisposable):
    ...
    @staticmethod
    def GetCircuitNamingSchemeSettings(cda):
        """
        GetCircuitNamingSchemeSettings(cda: Document) -> CircuitNamingSchemeSettings
    ...
    @staticmethod
    def IsValidCircuitNamingSchemeId(aDocument, circuitNamingSchemeId):
        """
        IsValidCircuitNamingSchemeId(aDocument: Document, circuitNamingSchemeId: ElementId) -> bool
        
            Verifies that the circuit naming scheme id can be used with 
    ...
    CircuitNamingSchemeId = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The circuit naming scheme id set in CircuitNamingSchemeSettings.

Get: CircuitNamingSchemeId(self: CircuitNamingSchemeSettings) -> ElementId

Set: CircuitNamingSchemeId(self: CircuitNamingSchemeSettings) = value
"""



class CircuitNumberingOption(Enum, IComparable, IFormattable, IConvertible):
    """
    An enumerated type listing all the circuit numbering options.
    
    enum CircuitNumberingOption, values: Continuous (1), Default (0)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class CorrectionFactor(APIObject, IDisposable):
    ...
    def GetTemperature(self):
        """
        GetTemperature(self: CorrectionFactor) -> float
        
            Get temperature which is used for specifying correction factor. The value 
             returned is quantified in
        the document's selected unit of electrical 
             temperature.
        """
        pass
...
class ElectricalCircuitPathMode(Enum, IComparable, IFormattable, IConvertible):
    """
    An enumerated type indicates the circuit path mode
    
    enum ElectricalCircuitPathMode, values: AllDevices (2), Custom (0), FarthestDevice (1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
class ElectricalEquipment(MEPModel, IDisposable):
    ...
    def GetCircuitNamingSchemeType(self):
        """
        GetCircuitNamingSchemeType(self: ElectricalEquipment) -> CircuitNaming
        
            Gets enumerated type of the circuit naming scheme used with Electrical 
             Equipment.
    ...
    def IsValidCircuitNamingSchemeId(aDocument, circuitNamingSchemeId):
        ...
        IsValidCircuitNamingSchemeId(aDocument: Document, circuitNamingSchemeId: ElementId) -> bool
            ...
            Verifies that the circuit naming scheme id can be used with Electrical 
             Equipment.
    ...
    def IsValidDistributionSystem(self, distributionSystem):
        """
        IsValidDistributionSystem(self: ElectricalEquipment, distributionSystem: DistributionSysType) -> bool
        
            Verifies that the Distribution System can be assigned to the Electrical 
             Equipment.
    ...
    def SetCircuitNamingSchemeType(self, circuitNamingType):
        """
        SetCircuitNamingSchemeType(self: ElectricalEquipment, circuitNamingType: CircuitNaming)
...
Get: CircuitNamingSchemeId(self: ElectricalEquipment) -> ElementId

Set: CircuitNamingSchemeId(self: ElectricalEquipment) = value
"""
...
"""
    ...
    IsSwitchboard = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The electrical equipment is a switchboard or not.
   This property returns true if the electrical equipment is a switchboard.

Get: IsSwitchboard(self: ElectricalEquipment) -> bool

"""

    MaxNumberOfCircuits = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The maximum number of circuits for switchboard.
   The quantity of circuits can be assigned to switchboard through breaker.

Get: MaxNumberOfCircuits(self: ElectricalEquipment) -> int

Set: MaxNumberOfCircuits(self: ElectricalEquipment) = value
"""
...
Get: Abbreviation(self: ElectricalLoadClassification) -> str

Set: Abbreviation(self: ElectricalLoadClassification) = value
"""
...
class ElectricalLoadClassificationData(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum ElectricalLoadClassificationData, values: Abbreviation (9), ActualElecLoadNameLabel (8), DemandFactor (2), LoadSummaryDemandFactorLabel (3), Name (0), PanelConnectedCurrentLabel (6), PanelConnectedLabel (4), PanelEstimatedCurrentLabel (7), PanelEstimatedLabel (5), SpaceLoadClass (1)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
...
"""
    ...
    CircuitPathOffset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The default circuit path offset for newly created circuit.

Get: CircuitPathOffset(self: ElectricalSetting) -> float

Set: CircuitPathOffset(self: ElectricalSetting) = value
"""
...
class ElectricalSystem(MEPSystem, IDisposable):
    ...
    def Create(*__args):
        """
        Create(document: Document, electComponents: IList[ElementId], elecSysType: ElectricalSystemType) -> ElectricalSystem
        Create(connector: Connector, elecSysType: ElectricalSystemType) -> ElectricalSystem
    ...
    def GetCircuitPath(self):
        """
        GetCircuitPath(self: ElectricalSystem) -> IList[XYZ]
    ...
    def IsCircuitPathValid(self, nodes):
        """ IsCircuitPathValid(self: ElectricalSystem, nodes: IList[XYZ]) -> bool """
        pass
    ...
    def SetCircuitPath(self, nodes):
        """ SetCircuitPath(self: ElectricalSystem, nodes: IList[XYZ]) """
        pass
...
"""
    ...
    CircuitConnectionType = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The circuit connection type of the electrical system.

Get: CircuitConnectionType(self: ElectricalSystem) -> CircuitConnectionType

Set: CircuitConnectionType(self: ElectricalSystem) = value
"""

    CircuitNamingIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: CircuitNamingIndex(self: ElectricalSystem) -> int
...
"""
    ...
    CircuitPathMode = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The circuit path mode of the electrical system.

Get: CircuitPathMode(self: ElectricalSystem) -> ElectricalCircuitPathMode

Set: CircuitPathMode(self: ElectricalSystem) = value
"""
...
Get: Frame(self: ElectricalSystem) -> float

Set: Frame(self: ElectricalSystem) = value
"""
...
"""
    ...
    HasCustomCircuitPath = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
...
Get: HasCustomCircuitPath(self: ElectricalSystem) -> bool

"""

    HasPathOffset = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Whether the circuit path has a valid offset.

Get: HasPathOffset(self: ElectricalSystem) -> bool
...
"""
    ...
    IsBasePanelFeedThroughLugsOccupied = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Checks if the feed through lugs of the base panel is already occupied.

Get: IsBasePanelFeedThroughLugsOccupied(self: ElectricalSystem) -> bool
...
"""
    ...
    LoadClassificationAbbreviations = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The LoadClassification Abbreviations used in the Electrical System.

Get: LoadClassificationAbbreviations(self: ElectricalSystem) -> str
...
Set: NeutralConductorsNumber(self: ElectricalSystem) = value
"""
...
Get: PathOffset(self: ElectricalSystem) -> float

Set: PathOffset(self: ElectricalSystem) = value
"""

    PhaseLabel = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The circuit phase label used in the Electrical System.

Get: PhaseLabel(self: ElectricalSystem) -> str
...
"""
    ...
    SlotIndex = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The Slots where the Electrical System is located in its panel.

Get: SlotIndex(self: ElectricalSystem) -> str
...
Set: TrueLoad(self: ElectricalSystem) = value
"""
...
"""
    ...
    Ways = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The circuit ways used in the Electrical System.

Get: Ways(self: ElectricalSystem) -> int
...
"""
    ...
    IsAutoShadingForLoadDisplay = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Display shading of load cells automatically or not.

Get: IsAutoShadingForLoadDisplay(self: PanelScheduleData) -> bool

Set: IsAutoShadingForLoadDisplay(self: PanelScheduleData) = value
"""
...
"""
    ...
    IsUnusedPhaseHidden = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """True if the user wishes to hide the unused phase column of a single phase panel, false otherwise.

Get: IsUnusedPhaseHidden(self: PanelScheduleData) -> bool

Set: IsUnusedPhaseHidden(self: PanelScheduleData) = value
"""
...
class PanelScheduleView(TableView, IDisposable):
    ...
    def AddSpace(self, nRow, nCol):
        """
        AddSpace(self: PanelScheduleView, nRow: int, nCol: int)
    ...
    def AddSpare(self, nRow, nCol):
        """
        AddSpare(self: PanelScheduleView, nRow: int, nCol: int)
    ...
    def RemoveSpace(self, nRow, nCol):
        """
        RemoveSpace(self: PanelScheduleView, nRow: int, nCol: int)
    ...
    def RemoveSpare(self, nRow, nCol):
        """
        RemoveSpare(self: PanelScheduleView, nRow: int, nCol: int)
    ...
    def RenumberIndexes(self):
        """
        RenumberIndexes(self: PanelScheduleView)
    ...
    def SwitchPhases(self, nRow, nCol):
        """
        SwitchPhases(self: PanelScheduleView, nRow: int, nCol: int)
...
class TemperatureRatingType(ElementType, IDisposable):
    ...
    def AddCorrectionFactor(self, temperature, factor):
        ...
        AddCorrectionFactor(self: TemperatureRatingType, temperature: float, factor: float) -> CorrectionFactor
        
            Add a new electrical correction factor type to this temperature rating type. 
             The given temperature
        value should be quantified in the document's selected 
             unit of electrical temperature.
        
        
            temperature: Temperature of correction factor to be added in the document's selected unit of 
...
class Wire(MEPCurve, IDisposable):
    ...
    def GetVertex(self, index):
        ...
        GetVertex(self: Wire, index: int) -> XYZ
           ...
           It is the offset point for the start and end 
             vertex, not the connector point.
           If the wire connects to one device, it may 
             have offset; otherwise, the start and end vertex is same as the connector 
             point.
        """
        pass
