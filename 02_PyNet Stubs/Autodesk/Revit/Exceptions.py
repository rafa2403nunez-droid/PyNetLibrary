...
Get: CurrentUser(self: CentralModelContentionException) -> str

"""



class CentralModelVersionArchivedException(CentralModelException, ISerializable, _Exception):
    """
    ...
    def GetObjectData(self, info, context):
        """
        GetObjectData(self: CentralModelVersionArchivedException, info: SerializationInfo, context: StreamingContext)
            Retrieves data needed to serialize the target object.
...
class CheckoutElementsRequestTooLargeException(CentralModelException, ISerializable, _Exception):
    ...
    def GetObjectData(self, info, context):
        """
        GetObjectData(self: CheckoutElementsRequestTooLargeException, info: SerializationInfo, context: StreamingContext)
            Retrieves data needed to serialize the target object.
...
class RevitServerModelAlreadyExistsException(RevitServerException, ISerializable, _Exception):
    ...
    def GetObjectData(self, info, context):
        """
        GetObjectData(self: RevitServerModelAlreadyExistsException, info: SerializationInfo, context: StreamingContext)
            Retrieves data needed to serialize the target object.
...
class RevitServerModelNameBreaksConventionException(RevitServerException, ISerializable, _Exception):
    ...
    def GetObjectData(self, info, context):
        """
        GetObjectData(self: RevitServerModelNameBreaksConventionException, info: SerializationInfo, context: StreamingContext)
            Retrieves data needed to serialize the target object.
