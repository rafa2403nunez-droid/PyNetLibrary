...
class Document(ItemFactoryBase, IDisposable):
    ...
    def NewExtrusionRoof(self, profile, refPlane, level, roofType, extrusionStart, extrusionEnd):
        ...
        NewExtrusionRoof(self: Document, profile: CurveArray, refPlane: ReferencePlane, level: Level, roofType: RoofType, extrusionStart: float, extrusionEnd: float) -> ExtrusionRoof
            ...
            profile: The profile of the extrusion roof. The curves of the profile must be contiguous 
             and form one open loop without self-intersections. The profile curves must lie 
             in the %refPlane% parallel to z-axis.
            ...
            extrusionStart: Start the extrusion. Measured from %refPlane% in the direction of the plane 
             normal.
        
            extrusionEnd: End the extrusion. Measured from %refPlane% in the direction of the plane 
             normal.
        """
        pass
...
class FamilyItemFactory(ItemFactoryBase, IDisposable):
    ...
    def NewBlend(self, isSolid, profile1, profile2, sketchPlane):
        """
        NewBlend(self: FamilyItemFactory, isSolid: bool, profile1: CurveArray, profile2: CurveArray, sketchPlane: SketchPlane) -> Blend
            ...
            profile2: The second blend section. It should represent a single, planar curve loop
        
             lying in a plane parallel to that of the first blend section.
        
            sketchPlane: The sketch plane for the first profile. Use this to associate the 
        "base" of 
             the blend to geometry from another element. Optional, it can be ll if you want 
             Revit
