...
class Application(object, IDisposable):
    ...
    def GetAssets(self, assetType):
        """
        GetAssets(self: Application, assetType: AssetType) -> IList[Asset]
    ...
    def GetSystemsAnalysisWorkflowNames(self):
        """
        GetSystemsAnalysisWorkflowNames(self: Application) -> IList[str]
    ...
    def GetSystemsAnalysisWorkflows(self):
        """
        GetSystemsAnalysisWorkflows(self: Application) -> IDictionary[str, str]
    ...
    def IsJournalPlaying(self):
        """
        IsJournalPlaying(self: Application) -> bool
    ...
    def OpenDocumentFile(self, *__args):
        ...
        OpenDocumentFile(self: Application, modelPath: ModelPath, openOptions: OpenOptions, openFromCloudCallback: IOpenFromCloudCallback) -> Document
        
            Opens a document from disk or cloud.
        
            modelPath: The file to be opened.
            openOptions: Options for opening the file.
            openFromCloudCallback: The interface implementation to use when opening a cloud document. Only used 
             for opening cloud model.
    ...
    def RegisterFailuresProcessor(processor):
        ...
        RegisterFailuresProcessor(processor: IFailuresProcessor)
            Replaces Revit's default user interface (if present) with alternative handling 
             for all warnings and errors
           (including those not generated by your 
             application) for the rest of the Revit session;
           if your application is not 
             prepared to respond to all warnings and errors,
           consider use of 
             IFailuresPreprocessor (in your opened Transaction)
           or the 
    ...
    def SetSystemsAnalysisWorkflows(self, paths):
        """ SetSystemsAnalysisWorkflows(self: Application, paths: IDictionary[str, str]) """
        pass
...
"""
    ...
    CurrentUsersAddinsDataFolderPath = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Path to AddinsData folder for the current user.

Get: CurrentUsersAddinsDataFolderPath(self: Application) -> str

"""

    CurrentUsersDataFolderPath = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Path to data folder for the current user.

Get: CurrentUsersDataFolderPath(self: Application) -> str
...
"""
    ...
    IsInfrastructureEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Checks whether or not infrastructure discipline is enabled, and enable or disable it.

Get: IsInfrastructureEnabled(self: Application) -> bool

Set: IsInfrastructureEnabled(self: Application) = value
"""
...
"""
    ...
    IsRouteAnalysisEnabled = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Checks whether or not route analysis is enabled, and enable or disable it.

Get: IsRouteAnalysisEnabled(self: Application) -> bool

Set: IsRouteAnalysisEnabled(self: Application) = value
"""
...
"""
    ...
    SubVersionNumber = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The minor version number of Revit

Get: SubVersionNumber(self: Application) -> str

"""

    SystemsAnalysisWorkfilesRootPath = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Root path for systems analysis workfiles

Get: SystemsAnalysisWorkfilesRootPath(self: Application) -> str
...
"""
    ...
    DocumentReloadedLatest = None
    DocumentReloadingLatest = None
    DocumentSaved = None
    ...
    FileImporting = None
    IsLoggedIn = True
    LinkedResourceOpened = None
    LinkedResourceOpening = None
    ...
    ViewPrinted = None
    ViewPrinting = None
    ViewsExportedByContext = None
    ViewsExportingByContext = None
...
class ControlledApplication(object):
    ...
    def IsJournalPlaying(self):
        """
        IsJournalPlaying(self: ControlledApplication) -> bool
...
Get: CurrentUsersAddinsDataFolderPath(self: ControlledApplication) -> str
...
Get: CurrentUsersDataFolderPath(self: ControlledApplication) -> str
...
Get: SubVersionNumber(self: ControlledApplication) -> str
...
class LanguageType(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum LanguageType, values: Brazilian_Portuguese (14), Chinese_Simplified (6), Chinese_Traditional (7), Czech (11), Dutch (5), English_GB (15), English_USA (0), French (3), German (1), Hungarian (13), Italian (4), Japanese (8), Korean (9), Polish (12), Russian (10), Spanish (2), Unknown (-1)
    """
