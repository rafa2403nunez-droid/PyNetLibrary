...
Get: IsChecked(self: CanExecuteEventArgs) -> bool

Set: IsChecked(self: CanExecuteEventArgs) = value
"""
...
class FabricationPartBrowserOperation(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum FabricationPartBrowserOperation, values: CreatedRoutingSolutions (4), FinishMPRoutingMode (8), FinishRoutingSolutionMode (6), FinishServiceSwapOutMode (10), FinishSizeSwapOutMode (14), HideBrowser (1), RoutingSolutionChanged (5), ShowBrowser (0), ShowService (2), StartMPRoutingMode (7), StartRoutingSolutionMode (3), StartServiceSwapOutMode (9), StartSizeSwapOutMode (13), SwitchToInlineFittingsTab (15), UnknownOperation (-1), UpdateServiceSwapOutPartTypes (11), UpdateServiceSwapOutSizes (12)
    """
    ...
    FinishMPRoutingMode = None
    FinishRoutingSolutionMode = None
    FinishServiceSwapOutMode = None
    FinishSizeSwapOutMode = None
    HideBrowser = None
    RoutingSolutionChanged = None
    ShowBrowser = None
    ShowService = None
    StartMPRoutingMode = None
    StartRoutingSolutionMode = None
    StartServiceSwapOutMode = None
    StartSizeSwapOutMode = None
    SwitchToInlineFittingsTab = None
    UnknownOperation = None
    UpdateServiceSwapOutPartTypes = None
    UpdateServiceSwapOutSizes = None
    value__ = None


class FormulaEditingEventArgs(RevitAPIPreEventArgs, IDisposable):
    """ The event arguments used by the DocumentSaving event. """
    def Apply(self, formula):
        """
        Apply(self: FormulaEditingEventArgs, formula: str)
...
Get: CurrentDocument(self: FormulaEditingEventArgs) -> Document
...
Get: Formula(self: FormulaEditingEventArgs) -> str
...
Get: ParameterId(self: FormulaEditingEventArgs) -> ElementId
...
class TransferredProjectStandardsEventArgs(RevitAPISingleEventArgs, IDisposable):
...
class TransferringProjectStandardsEventArgs(RevitAPIPreDocEventArgs, IDisposable):
