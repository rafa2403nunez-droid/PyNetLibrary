...
# from RevitAPIUI, Version=22.0.0.0, Culture=neutral, PublicKeyToken=null
# by generator 1.145
# no doc
# no imports
...
class DockablePaneProviderData(object):
    ...
    """
    def GetFrameworkElement(self):
        """
        GetFrameworkElement(self: DockablePaneProviderData) -> FrameworkElement
        
            Wrapper function that returns the FrameworkElement for this provider.
            Returns: FrameworkElement to use as the pane's user interface.
        """
        pass
...
"""
    ...
    FrameworkElementCreator = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """A creator that will be called for the pane if the FrameworkElement is not set.

Get: FrameworkElementCreator(self: DockablePaneProviderData) -> IFrameworkElementCreator

Set: FrameworkElementCreator(self: DockablePaneProviderData) = value
"""
...
class DockablePaneState(object, IDisposable):
    ...
    def SetFloatingRectangle(self, rect):
        ...
        SetFloatingRectangle(self: DockablePaneState, rect: Rectangle)
            ...
            rect: The rectangle to use when floating.
        """
        pass
...
Get: MinimumHeight(self: DockablePaneState) -> int

Set: MinimumHeight(self: DockablePaneState) = value
"""
...
Get: MinimumWidth(self: DockablePaneState) -> int

Set: MinimumWidth(self: DockablePaneState) = value
"""
...
class DoubleClickOptions(object, IDisposable):
    ...
    def GetRenameOnSlowDoubleClickInProjectBrowser(self):
        """
        GetRenameOnSlowDoubleClickInProjectBrowser(self: DoubleClickOptions) -> bool
        
            Returns the user's desire to rename item in project browser on slow 
             double-click.
        """
        pass
    ...
    def SetRenameOnSlowDoubleClickInProjectBrowser(self, bRenameOnSlowDoubleClickInProjectBrowser):
        """
        SetRenameOnSlowDoubleClickInProjectBrowser(self: DoubleClickOptions, bRenameOnSlowDoubleClickInProjectBrowser: bool)
            Sets whether the desired action is to rename item in project browser on slow 
             double-click.
        """
        pass
...
class IExternalResourceUIServer(IExternalServer):
    ...
    def HandleBrowseResult(self, resultType, browsingItemPath):
        ...
        HandleBrowseResult(self: IExternalResourceUIServer, resultType: ExternalResourceUIBrowseResultType, browsingItemPath: str)
           ...
           in 
             the UI. It is recommended that the server only respond in the case of a 
             critical error.
        
        
            resultType: The result of the browsing operation.
            browsingItemPath: The absolute path of the current item being browsed.
        """
        pass
...
class IFrameworkElementCreator:
    ...
    Interface that the Revit UI will call, if present, to construct the FrameworkElement
       for the pane.
    """
    def CreateFrameworkElement(self):
        """
        CreateFrameworkElement(self: IFrameworkElementCreator) -> FrameworkElement
...
class ITemporaryGraphicsHandler(IExternalServer):
    """ Interface class for external server of Autodesk.Revit.DB.ExternalService.ExternalServices.BuiltInExternalServices.TemporaryGraphicsHandlerService. """
    def OnClick(self, data):
        """
        OnClick(self: ITemporaryGraphicsHandler, data: TemporaryGraphicsCommandData)
            Handles mouse click event on a given temporary graphics object managed by 
             Autodesk.Revit.DB.TemporaryGraphicsManager.
        
        
            data: The context data of the click event.
        """
        pass
...
class PostableCommand(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum PostableCommand, values: AcquireCoordinates (33863), ActivateView (33181), AddToSet (33908), AdjustAnalyticalModel (35739), AirTerminal (37005), Align (33218), AlignedDimension (48955), AlignedMultiRebarAnnotation (35831), AlignedToCurrentView (33320), AlignedToPickedLevel (33321), AlignedToSamePlace (33341), AlignedToSelectedLevels (33328), AlignedToSelectedViews (33332), AlignmentStation (1115), AlignmentStationLabelTypes (33354), AlignmentStationSet (1116), AllowableBarTypes (35599), AnalysisDisplayStyles (32948), AnalyticalConsistencyChecks (3411), Anchors (54295), AngularDimension (48957), AngularDimensionTypes (1082), ApplyCoping (46450), ApplyTemplatePropertiesToCurrentView (33651), ArchitecturalColumn (32918), ArchitecturalFloor (32914), ArchitecturalWall (32771), ArcLengthDimension (48959), ArcWire (37106), Area (33720), AreaAndVolumeComputations (40382), AreaBoundary (33719), AreaPlan (33638), AreaReinforcementSymbol (46959), AreaTag (33718), Array (33121), Arrowheads (33349), AssemblyCode (54096), AutomaticBeamSystem (42398), AutomaticCeiling (33158), BatchPrint (56308), Beam (34972), BeamAnnotations (35585), BeamOrColumnJoins (49543), BeamSystemSymbol (46567), Bolts (54293), BottomChord (3621), BoundaryConditions (35223), Brace (34973), BrowserOrganization (33904), BuildingElevation (33255), BuildingOrSpaceTypeSettings (37259), BuildingPad (33481), CableTray (37297), CableTrayConnector (37291), CableTrayFitting (37295), Callout (33298), CalloutTags (3167), Camera (32956), ChamferedWire (37260), CheckCircuits (37062), CheckDuctSystems (37167), CheckMemberSupports (3410), CheckPipeSystems (37155), CheckSpelling (40986), Close (57602), CloseInactiveViews (33712), Collaborate (54057), CollaborateInCloud (54058), ColorFillLegend (33252), ColorSchemes (48739), Communication (37278), Conduit (37298), ConduitConnector (37292), ConduitFitting (37296), ConnectionSettings (996), ContourCut (54297), Control (33034), ConvertToFlexDuct (37014), CoordinationModel (4561), CoordinationReviewUseCurrentProject (35110), CoordinationSelectLink (35111), CoordinationSettings (35149), Cope (55304), CopeSkewed (54286), Copy (33129), CopyMonitorSelectLink (35108), CopyMonitorUseCurrentProject (35107), CopyToClipboard (57634), CornerCut (54288), CreateAssembly (53677), CreateEnergyModel (53964), CreateGroup (33305), CreateParts (35425), CreateSimilar (33441), CreateTemplateFromCurrentView (33684), CurtainGrid (33199), CurtainSystemByFace (35072), CurtainWallMullion (33200), CutBy (55309), CutGeometry (33407), CutProfile (33709), CutThrough (55308), CutToClipboard (57635), Data (37279), DeactivateView (33185), DecalTypes (33188), Default3DView (33169), Delete (32778), DeleteEnergyModel (54224), DemandFactors (37068), Demolish (33534), DesignOptions (33907), DetailComponent (33424), DetailLevel (33384), DetailLine (33425), DiameterDimension (35778), DiameterDimensionTypes (35779), DisplaceElements (54029), Door (32772), DormerOpening (35255), DraftingView (33530), DrawOnFace (2706), DrawOnWorkPlane (2707), Duct (37006), DuctAccessory (37004), DuctConnector (37218), DuctFitting (37009), DuctLegend (37027), DuctPlaceholder (37427), DuctPressureLossReport (35811), DuplicateAsDependent (35280), DuplicateView (33245), DuplicateWithDetailing (33858), DWFMarkup (3401), Dynamo (54157), DynamoPlayer (57282), EditATemplate (37315), EditingRequests (33911), EditRebarCover (48583), EditSelection (35183), ElectricalConnector (37217), ElectricalEquipment (37060), ElectricalFixture (37061), ElectricalSettings (37054), ElementKeynote (35158), ElevationTags (3168), EnergySettings (53612), ExitRevit (57665), ExportCADFormatsACIS_SAT (3345), ExportCADFormatsDGN (3344), ExportCADFormatsDWG (3342), ExportCADFormatsDXF (3343), ExportCADFormatsSTL (3347), ExportDWFOrDWFx (3341), ExportExportTypes (3405), ExportFBX (35350), ExportGBXML (53615), ExportIFC (3278), ExportImagesandAnimationsImage (33838), ExportImagesandAnimationsSolarStudy (12075), ExportImagesandAnimationsWalkthrough (12059), ExportODBCDatabase (33693), ExportOptionsExportSetupsDGN (33248), ExportOptionsExportSetupsDWGOrDXF (33251), ExportOptionsIFCOptions (3292), ExportPDF (3346), ExportReportsRoomOrAreaReport (3125), ExportReportsSchedule (33710), FabricationPart (54149), FabricationSettings (35839), FabricReinforcementSymbol (35793), FamilyCategoryAndParameters (10133), FamilyTypes (33203), Fascia (40601), FilledRegion (33204), FillPatterns (33163), Filters (33099), FindOrReplace (53591), FireAlarm (37280), FlexDuct (37010), FlexPipe (37102), FloorByFaceFloor (3234), FloorPlan (32953), FormWorkPlaneView (35703), FramingElevation (32814), Generate (53613), GenerateAnalysis (56376), GlobalParameters (54055), GradedRegion (33640), GraphicalColumnSchedule (46139), GrayInactiveWorksets (2765), Grid (32770), GuideGrid (53675), Gutter (40602), HalftoneOrUnderlay (49786), HideCategory (3240), HideElements (35261), Holes (54294), IdsOfSelection (33866), ImportCAD (32959), ImportGBXML (3102), ImportImage (33499), ImportPDF (33503), ImportTypes (3404), InPlaceMass (42645), Insert2DElementsFromFile (42310), InsertViewsFromFile (42309), Insulation (33432), Isolated (35114), JoinGeometry (33729), JoinOrUnjoinRoof (33277), KeyboardShortcuts (49211), KeynoteLegend (3449), KeynotingSettings (3450), Label (33174), LabelContours (33820), Legend (33531), LegendComponent (33751), Level (32794), Lighting (37281), LightingFixture (37059), LinearDimension (48956), LinearDimensionTypes (1081), LinearMultiRebarAnnotation (35832), LinePatterns (33120), LineStyles (33360), LineWeights (32946), Linework (33520), LinkCAD (32961), LinkFormit (35856), LinkIFC (35853), LinkImage (56282), LinkPDF (56281), LinkRevit (33836), LinkTopography (57288), LoadAsGroup (33695), LoadAsGroupIntoOpenProjects (786), LoadAutodeskFamily (32990), LoadCases (53531), LoadClassifications (37055), LoadCombinations (53532), LoadedTagsAndSymbols (33338), LoadFamilyIntoProjectAndClose (54133), LoadIntoProject (791), LoadRebarShapeIntoProjectAndClose (54151), Loads (34987), LoadSelection (35180), LoadShapes (32984), Location (33862), MacroManager (35602), MacroSecurity (35603), MajorSegment (35293), ManageCloudModels (54059), ManageConnectionToARevitServerAccelerator (53949), ManageImages (33648), ManageLinks (33279), ManageTemplates (37314), ManageViewTemplates (33683), MaskingRegion (35287), Matchline (33905), MatchTypeProperties (33513), MaterialAssets (33186), MaterialKeynote (35159), Materials (33184), MaterialTag (35145), MaterialTakeoff (3388), MeasureAlongAnElement (48963), MeasureBetweenTwoReferences (48962), MechanicalEquipment (37008), MechanicalSettings (37168), MergeSurfaces (33742), MirrorDrawAxis (49000), MirrorPickAxis (32936), MirrorProject (32919), Miter (55305), ModelInPlace (33544), ModelLine (33006), ModelText (33660), Move (33127), MultiCategoryTag (35203), Multiplanar (50051), MultiplePaths (54125), MultipleValuesIndication (54124), MultiPointRouting (37574), NavigationBar (35631), NewAnnotationSymbol (33339), NewConceptualMass (32986), NewFamily (32983), NewProject (33179), NewSheet (32958), NewTitleBlock (33140), NoteBlock (33659), NurseCall (37282), ObjectStyles (32947), Offset (33757), OneWayIndicator (54126), OpenBuildingComponent (3470), OpenCloudModel (56379), OpenFamily (35365), OpenIFC (3355), OpenIFCOptions (3409), Opening (33177), OpeningByFace (35253), OpenProject (51800), OpenRevitFile (57601), OpenSampleFiles (35815), Optimize (57289), Options (33195), OverrideByCategory (33422), OverrideByElement (35265), OverrideByFilter (35266), Paint (33656), PAndIDModeler (35882), PAndIDSettings (35883), PanelSchedules (37053), ParallelConduits (37361), ParallelPipes (37441), ParkingComponent (33698), PasteFromClipboard (57637), PathOfTravel (54122), PathReinforcementSymbol (35228), PeopleContent (54127), Phases (33472), PickToEdit (33910), Pin (32997), Pipe (37100), PipeAccessory (37105), PipeConnector (37219), PipeFitting (37103), PipeLegend (37149), PipePlaceholder (37428), PipePressureLossReport (35812), PlaceAComponent (33003), PlaceDecal (33789), PlaceDetailGroup (33421), PlaceMass (42644), PlaceOnStairOrRamp (35807), PlaceView (33132), PlanRegion (33900), Plate (54292), PlumbingFixture (37203), PointCloud (32963), Print (57607), PrintPreview (57609), PrintSetup (57606), ProjectBrowser (32957), ProjectInformation (33543), ProjectParameters (33855), ProjectUnits (32950), PropertyLine (33480), PublishCoordinates (33869), PublishSettings (54064), PurgeUnused (33780), RadialDimension (48958), RadialDimensionTypes (1199), Railing (34969), Ramp (33316), RebarCoverSettings (35003), RebarLine (33810), ReconcileHosting (35708), Redo (33031), ReferenceLine (34994), ReferencePlane (33026), ReflectedCeilingPlan (33380), ReinforcementNumbers (4700), ReinforcementSettings (35300), RelinquishAllMine (3363), ReloadLatest (1729), RelocateProject (33856), RemoveCoping (46451), RemoveHiddenLinesByElement (33673), RemovePaint (33657), Render (1782), RenderGallery (53962), RenderInCloud (53961), RepairCentralModel (57283), RepeatComponent (840), RepeatingDetailComponent (42058), ReportSharedCoordinates (33865), ResetAnalyticalModel (3288), ResetSharedCoordinates (56335), RestoreBackup (33690), RevealObstacles (54111), RevealWall (33654), ReviewWarnings (33352), RevisionCloud (33540), RevisionSchedule (3154), RoofByExtrusion (1143), RoofByFace (20), RoofByFootprint (1142), Room (33198), RoomSeparator (33318), RoomTag (33208), Rotate (32934), RotateProjectNorth (32920), RotateTrueNorth (33857), RunInterferenceCheck (3259), Save (57603), SaveAsCloudModel (56243), SaveAsFamily (49784), SaveAsLibraryFamily (33923), SaveAsLibraryGroup (33696), SaveAsLibraryView (42312), SaveAsProject (57604), SaveAsTemplate (49783), SaveSelection (35181), SawCutFlange (55306), SawCutWeb (55307), Scale (34986), ScheduleOrQuantities (33296), ScopeBox (33519), Section (32955), SectionTags (3169), Security (37283), SelectById (33867), SelectionBox (35857), SetWorkPlane (33527), ShaftOpening (35257), ShapeStatus (3640), SharedParameters (33748), SharedViews (56329), ShearStuds (54296), SheetIssuesOrRevisions (3153), SheetList (33631), Shorten (54264), ShowDisconnects (37444), ShowHiddenLinesByElement (33671), ShowHistory (1985), ShowLastReport (46061), ShowMassByViewSettings (35075), ShowMassFormAndFloors (35060), ShowMassSurfaceTypes (35078), ShowMassZonesAndShades (35079), ShowWarningsInViews (1000), ShowWorkPlane (40484), SingleFabricSheetPlacement (35823), SiteComponent (40239), Slab (35156), SlabEdgeFloor (40603), Snaps (32949), Soffit (493), SolidBlend (33278), SolidExtrusion (33002), SolidRevolve (33287), SolidSweep (33300), SolidSweptBlend (47163), Space (32784), SpaceNaming (57269), SpaceSeparator (32786), SpaceTag (32785), SpanDirectionSymbol (34980), SpatialGrid (54128), SpecifyCoordinatesAtPoint (3266), SplineWire (37261), SplitElement (1100), SplitFace (33689), SplitSurface (1992), SplitWithGap (33829), SpotCoordinate (1114), SpotCoordinateTypes (33351), SpotElevation (1109), SpotElevationTypes (33350), SpotSlope (35259), SpotSlopeTypes (33348), Sprinkler (37206), Stair (32916), StairPath (33010), StairTreadOrRiserNumber (53827), StartingView (33327), StatusBar (59393), StatusBarDesignOptions (4610), StatusBarWorksets (4609), StructuralAreaReinforcement (46932), StructuralColumn (34974), StructuralConnection (997), StructuralFabricArea (35781), StructuralFloor (34985), StructuralPathReinforcement (35225), StructuralPlan (32952), StructuralRebar (35098), StructuralRebarCoupler (35862), StructuralSettings (34993), StructuralTrusses (43213), StructuralWall (34975), Subregion (34964), SunSettings (12299), SweepWall (33655), SwitchJoinOrder (33731), Symbol (33221), SymbolicLine (33700), SynchronizeAndModifySettings (33542), SynchronizeNow (42654), SystemBrowser (3280), SystemsAnalysis (56254), SystemZone (37617), TabViews (57650), TagAllNotTagged (33735), TagByCategory (33329), Telephone (37284), TemporaryDimensions (33100), Text (33134), ThinLines (33834), TileViews (57652), TitleBlock (33806), ToggleHome (56242), TogglePAndIDModelerBrowser (35884), TogglePropertiesPalette (4534), ToggleRevealHiddenElementsMode (35263), TopChord (3620), Toposurface (33641), TransferProjectStandards (33699), TrimOrExtendMultipleElements (48954), TrimOrExtendSingleElement (48953), TrimOrExtendToCorner (48952), TypeProperties (3302), UncutGeometry (33408), Undo (33032), UnjoinGeometry (33730), Unpin (33001), UserKeynote (35160), VerticalOpening (35254), ViewAnalysis (56377), ViewCube (35458), ViewList (1075), ViewReference (33906), VisibilityOrGraphics (33175), VoidBlend (33398), VoidExtrusion (33397), VoidRevolve (33399), VoidSweep (33400), VoidSweptBlend (47164), Walkthrough (33000), Wall (35113), WallByFaceWall (35074), WallJoins (33323), WallOpening (35256), Web (3619), Welds (54290), Window (32773), Worksets (33460), WorksharingMonitor (56309), Zone (37244)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
    ...
    AlignmentStation = None
    AlignmentStationLabelTypes = None
    AlignmentStationSet = None
    ...
    CheckSpelling = None
    Close = None
    CloseInactiveViews = None
    Collaborate = None
    CollaborateInCloud = None
    ...
    CoordinationModel = None
    CoordinationReviewUseCurrentProject = None
    CoordinationSelectLink = None
    CoordinationSettings = None
    Cope = None
    CopeSkewed = None
    Copy = None
    CopyMonitorSelectLink = None
    CopyMonitorUseCurrentProject = None
    CopyToClipboard = None
    CornerCut = None
    CreateAssembly = None
    CreateEnergyModel = None
    CreateGroup = None
    CreateParts = None
    CreateSimilar = None
    ...
    LinkTopography = None
    LoadAsGroup = None
    LoadAsGroupIntoOpenProjects = None
    LoadAutodeskFamily = None
    LoadCases = None
    LoadClassifications = None
    LoadCombinations = None
    LoadedTagsAndSymbols = None
    LoadFamilyIntoProjectAndClose = None
    LoadIntoProject = None
    LoadRebarShapeIntoProjectAndClose = None
    Loads = None
    LoadSelection = None
    LoadShapes = None
    Location = None
    ...
    Multiplanar = None
    MultiplePaths = None
    MultipleValuesIndication = None
    MultiPointRouting = None
    NavigationBar = None
    ...
    TitleBlock = None
    ToggleHome = None
    TogglePAndIDModelerBrowser = None
    TogglePropertiesPalette = None
    ToggleRevealHiddenElementsMode = None
    TopChord = None
    Toposurface = None
...
class RevitLinkUIUtils(object):
    ...
    def ReportLinkLoadResults(doc, loadResults):
        """ ReportLinkLoadResults(doc: Document, loadResults: IDictionary[str, LinkLoadResult]) """
        pass
...
class RibbonButtonOptions(object, IDisposable):
    """ A utility class containing the Revit.ini options settings related to ribbon buttons """
    def Dispose(self):
        """ Dispose(self: RibbonButtonOptions) """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: RibbonButtonOptions, disposing: bool) """
        pass
...
Get: IsValidObject(self: RibbonButtonOptions) -> bool
...
class TaskDialog(APIObject, IDisposable):
    ...
    def EnableDoNotShowAgain(self, dialogId, enableDoNotShow, doNotShowText):
        """
        EnableDoNotShowAgain(self: TaskDialog, dialogId: str, enableDoNotShow: bool, doNotShowText: str)
            Enables the "Do not show again" for a task dialog.
        
            dialogId: The non localized dialog identifier. It is used to store in Revit.ini the 
             choice the user made the last time the dialog was shown.
        
            enableDoNotShow: The boolean to enable or disable the do not show me again functionality.
            doNotShowText: The customized localized string that shows along with the do not show again 
             checkbox.
        """
        pass
...
"""
    ...
    EnableMarqueeProgressBar = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Enables a marquee style progress bar to be displayed in the TaskDialog.

Get: EnableMarqueeProgressBar(self: TaskDialog) -> bool

Set: EnableMarqueeProgressBar(self: TaskDialog) = value
"""
...
class TaskDialogIcon(Enum, IComparable, IFormattable, IConvertible):
    ...
    enum TaskDialogIcon, values: TaskDialogIconError (65534), TaskDialogIconInformation (65533), TaskDialogIconNone (0), TaskDialogIconShield (65532), TaskDialogIconWarning (65535)
    """
    def __eq__(self, *args): #cannot find CLR method
        """ x.__eq__(y) <==> x==yx.__eq__(y) <==> x==yx.__eq__(y) <==> x==y """
        pass
    ...
    TaskDialogIconError = None
    TaskDialogIconInformation = None
    TaskDialogIconNone = None
    TaskDialogIconShield = None
...
class TemporaryGraphicsCommandData(object, IExternalData, IDisposable):
    """ The context data that can be provided to Autodesk.Revit.UI.ITemporaryGraphicsHandler.OnClick(Autodesk.Revit.UI.TemporaryGraphicsCommandData). """
    def Dispose(self):
        """ Dispose(self: TemporaryGraphicsCommandData) """
        pass

    def ReleaseUnmanagedResources(self, *args): #cannot find CLR method
        """ ReleaseUnmanagedResources(self: TemporaryGraphicsCommandData, disposing: bool) """
        pass
...
Get: Document(self: TemporaryGraphicsCommandData) -> Document

"""

    Index = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The unique index of the temporary graphics object managed by Autodesk.Revit.DB.TemporaryGraphicsManager.

Get: Index(self: TemporaryGraphicsCommandData) -> int
...
Get: IsValidObject(self: TemporaryGraphicsCommandData) -> bool
...
class UIApplication(object, IDisposable):
    ...
    def OpenAndActivateDocument(self, *__args):
        ...
        OpenAndActivateDocument(self: UIApplication, modelPath: ModelPath, openOptions: OpenOptions, detachAndPrompt: bool) -> UIDocument
        
            Opens and activates a Revit document, include both local document or cloud 
             document.
           ...
           The file can be either a Revit 
            ...
            detachAndPrompt: True means if openOptions specifies DoNotDetach,
           ...
           make no sense when opening a cloud document.
            ...
            Returns: The opened document.
        OpenAndActivateDocument(self: UIApplication, modelPath: ModelPath, openOptions: OpenOptions, detachAndPrompt: bool, openFromCloudCallback: IOpenFromCloudCallback) -> UIDocument
           ...
           make no sense when opening a cloud document.
            ...
            openFromCloudCallback: Callback function that allow caller to handle cases when conflicts happen 
             during opening a cloud document.
           Make no sense when opening a non-cloud 
             document.
...
"""
    ...
    IsViewerModeActive = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Determines if Revit session is in Viewer mode.

Get: IsViewerModeActive(self: UIApplication) -> bool
...
Get: MainWindowHandle(self: UIApplication) -> IntPtr

"""

    ProductIsRS = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Identifies if the current Revit product has an RS designation.  Most add-ins will not need to use this information.

Get: ProductIsRS(self: UIApplication) -> bool
...
Get: IsViewerModeActive(self: UIControlledApplication) -> bool
...
Get: MainWindowHandle(self: UIControlledApplication) -> IntPtr
...
Get: ProductIsRS(self: UIControlledApplication) -> bool
...
class UIDocument(object, IDisposable):
    ...
    def CanPlaceElementType(self, elementType):
        ...
        CanPlaceElementType(self: UIDocument, elementType: ElementType) -> bool
            ...
            Verifies that the user can be prompted to place the input element type 
             interactively.
        
        
            elementType: The ElementType.
            Returns: True if the user can be prompted to place the input element type interactively, 
             false otherwise.
        """
        pass
    ...
    def UpdateAllOpenViews(self):
        """
        UpdateAllOpenViews(self: UIDocument)
            Update all open views in this document after elements have been changed, 
             deleted, selected or de-selected.
           Graphics in the views are fully redrawn 
             regardless of which elements have changed.
        """
        pass
