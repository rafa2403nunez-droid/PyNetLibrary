# encoding: utf-8
# module Autodesk.Navisworks.Api.Controls calls itself Controls
# from Autodesk.Navisworks.Controls, Version=19.0.1374.1, Culture=neutral, PublicKeyToken=d85e58fa5af9b484
# by generator 1.145
# no doc
# no imports
...
class ApplicationControl(object):
    ...
    def Initialize():
        ...
        to Autodesk.Navisworks.Api.Controls.ApplicationControl.TerminateTerminate.
        """
        pass

    @staticmethod
    def SetApplicationGui(gui):
        """
        SetApplicationGui(gui: IApplicationGui)
            Sets/clears the implementation of IApplicationGui returned by 
        Autodesk.Navisworks.Api.Application.GuiApplication.Gui.
        """
        pass
    ...
    def Terminate():
        ...
        to Autodesk.Navisworks.Api.Controls.ApplicationControl.InitializeInitialize.
        """
        pass
...
class ApplicationType(Enum, IComparable, IFormattable, IConvertible):
    """
    Describes the type of application that will be built using Navisworks controls.
    
    enum ApplicationType, values: MultipleDocument (0), SingleDocument (1)
    """
    ...
    MultipleDocument = None
    SingleDocument = None
    value__ = None


class DocumentControl(MarshalByValueComponent, IComponent, IDisposable, IServiceProvider):
    """
    Standalone component that manages a Navisworks document
    
    DocumentControl(container: IContainer)
    DocumentControl()
    """
    def Dispose(self):
        """ Dispose(self: DocumentControl, A_0: bool) """
        pass

    def SetAsMainDocument(self):
        """
        SetAsMainDocument(self: DocumentControl)
            Set this control's document as the main document for the application. This should be called
        once at the beginning of the application. This DocumentControl should last for the 
             lifetime
        of the application and be the last DocumentControl to be disposed when the application terminates.
        """
        pass

    def ShowCullingOptionsGui(self):
        """
        ShowCullingOptionsGui(self: DocumentControl)
...
Get: Document(self: DocumentControl) -> Document
...
class ViewControl(Control, IComponent, IDisposable, IOleControl, IOleObject, IOleInPlaceObject, IOleInPlaceActiveObject, IOleWindow, IViewObject, IViewObject2, IPersist, IPersistStreamInit, IPersistPropertyBag, IPersistStorage, IQuickActivate, ISupportOleDropSource, IDropTarget, ISynchronizeInvoke, IWin32Window, IArrangedElement, IBindableComponent, IKeyboardToolTip):
    ...
    def Dispose(self):
        """ Dispose(self: ViewControl, A_0: bool) """
        pass
    ...
    def GetAccessibilityObjectById(self, *args): #cannot find CLR method
        ...
        GetAccessibilityObjectById(self: Control, objectId: int) -> AccessibleObject
            ...
            objectId: An t32 that identifies the System.Windows.Forms.AccessibleObject to retrieve.
            Returns: The specified System.Windows.Forms.AccessibleObject.
        """
        pass
    ...
    def GetStyle(self, *args): #cannot find CLR method
        ...
        GetStyle(self: Control, flag: ControlStyles) -> bool
            ...
            Returns: ue if the specified control style bit is set to ue; otherwise, lse.
        """
        pass
    ...
    def GetTopLevel(self, *args): #cannot find CLR method
        ...
        GetTopLevel(self: Control) -> bool
            ...
            Returns: ue if the control is a top-level control; otherwise, lse.
        """
        pass
    ...
    def InvokePaintBackground(self, *args): #cannot find CLR method
        ...
        InvokePaintBackground(self: Control, c: Control, e: PaintEventArgs)
            Raises the intBackground event for the specified control.
    ...
    def IsInputChar(self, *args): #cannot find CLR method
        ...
        IsInputChar(self: Control, charCode: Char) -> bool
            ...
            Returns: ue if the character should be sent directly to the control and not preprocessed; otherwise, lse.
        """
        pass

    def IsInputKey(self, *args): #cannot find CLR method
        """
        IsInputKey(self: ViewControl, keyData: Keys) -> bool
    ...
    def OnCreateControl(self, *args): #cannot find CLR method
        """ OnCreateControl(self: ViewControl) """
        pass
    ...
    def OnDpiChangedAfterParent(self, *args): #cannot find CLR method
        ...
        OnDpiChangedAfterParent(self: Control, e: EventArgs)
            ...
            e: An System.Windows.Forms.DpiChangedEventArgs that contains the event data.
        """
        pass
    ...
    def OnPaint(self, *args): #cannot find CLR method
        """ OnPaint(self: ViewControl, e: PaintEventArgs) """
        pass
    ...
    def ProcessCmdKey(self, *args): #cannot find CLR method
        ...
        ProcessCmdKey(self: Control, msg: Message, keyData: Keys) -> (bool, Message)
            ...
            Returns: ue if the character was processed by the control; otherwise, lse.
        """
        pass
    ...
    def ProcessDialogKey(self, *args): #cannot find CLR method
        ...
        ProcessDialogKey(self: Control, keyData: Keys) -> bool
            ...
            keyData: One of the System.Windows.Forms.Keys values that represents the key to process.
            Returns: ue if the key was processed by the control; otherwise, lse.
        """
        pass
    ...
    def ProcessKeyEventArgs(self, *args): #cannot find CLR method
        ...
        ProcessKeyEventArgs(self: Control, m: Message) -> (bool, Message)
            ...
            Returns: ue if the message was processed by the control; otherwise, lse.
        """
        pass
    ...
    def ProcessMnemonic(self, *args): #cannot find CLR method
        ...
        ProcessMnemonic(self: Control, charCode: Char) -> bool
            ...
            charCode: The character to process.
            Returns: ue if the character was processed as a mnemonic by the control; otherwise, lse.
        """
        pass
    ...
    def RescaleConstantsForDpi(self, *args): #cannot find CLR method
        ...
        RescaleConstantsForDpi(self: Control, deviceDpiOld: int, deviceDpiNew: int)
            ...
            deviceDpiOld: The DPI value prior to the change.
            deviceDpiNew: The DPI value after the change.
        """
        pass
    ...
    def Select(self):
        ...
        Select(self: Control, directed: bool, forward: bool)
            ...
            directed: ue to specify the direction of the control to select; otherwise, lse.
            forward: ue to move forward in the tab order; lse to move backward in the tab order.
        """
        pass

    def SetActiveView(self):
        """
        SetActiveView(self: ViewControl)
    ...
    def SetStyle(self, *args): #cannot find CLR method
        ...
        SetStyle(self: Control, flag: ControlStyles, value: bool)
            Sets a specified System.Windows.Forms.ControlStyles flag to either ue or lse.
        
            flag: The System.Windows.Forms.ControlStyles bit to set.
            value: ue to apply the specified style to the control; otherwise, lse.
        """
        pass
    ...
    def SetTopLevel(self, *args): #cannot find CLR method
        ...
        SetTopLevel(self: Control, value: bool)
            ...
            value: ue to set the control as the top-level control; otherwise, lse.
        """
        pass
    ...
    def SetVisibleCore(self, *args): #cannot find CLR method
        ...
        SetVisibleCore(self: Control, value: bool)
            ...
            value: ue to make the control visible; otherwise, lse.
        """
        pass
    ...
    def WndProc(self, *args): #cannot find CLR method
        """
        WndProc(self: ViewControl, m: Message) -> Message
    ...
    AllowCurrentSelectionDrag = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """Determines if Selection dragging is enabled

Get: AllowCurrentSelectionDrag(self: ViewControl) -> bool

Set: AllowCurrentSelectionDrag(self: ViewControl) = value
"""
...
"""
    ...
    DocumentControl = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    """The DocumentControl that this view displays

Get: DocumentControl(self: ViewControl) -> DocumentControl

Set: DocumentControl(self: ViewControl) = value
"""
...
Get: View(self: ViewControl) -> View
